<?php
    $rsql="SELECT * FROM `pengusul` WHERE `no_pendaftaran`='$_SESSION[namauser]'";
	$getuser=$conn->query($rsql);
	$r=$getuser->fetch_assoc();
	echo "<!-- Content Header (Page header) -->
    <section class='content-header'>
      <h1>
        Ubah Kata Sandi (Password) Pengusul
        ...
        <div class='col-xs-12'>
          <div class='box'>
            <div class='box-header'>
              <h3 class='box-title'>Ubah Kata Sandi/Password Pengguna $_SESSION[namauser]</h3>
            </div>
            <!-- /.box-header -->
            <div class='box-body'>
          <form method='POST' action='modul/mod_password/aksi_password.php'>
          <input type='hidden' name='username' value='$r[no_pendaftaran]'>

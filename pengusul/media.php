...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){
 ...
 <center><br><br><br><br><br><br>Maaf, untuk masuk <b>Halaman Pengusul</b><br>
...
<title>Dahsboard Pengusul | Sistem Informasi Lembaga Sertifikasi Profesi</title>
...
<div class='wrapper'>
  ...
  <header class='main-header'>
    ...
    <a href='?module=home' class='logo'>
      ...
      <span class='logo-lg'>Institusi <b>Pengusul</b></span>
    </a>
    ...
    <nav class='navbar navbar-static-top' role='navigation'>
      ...
      <div class='navbar-custom-menu'>
		...
		$sqlgethpasr="SELECT * FROM `pengusul` WHERE `no_pendaftaran`='$_SESSION[namauser]'";
...
include "content.php"; 
  ...
  <footer class='main-footer'>
	...
	$tahun=date("Y"); 
	echo "$tahun <a href='#'>LSPPPM</a>.</strong> All rights reserved.
    reserved.
  </footer>
...
$sqlgetkotaX="SELECT DISTINCT `kota` FROM `asesi`";
$getkotaX=$conn->query($sqlgetkotaX);
while ($gkX=$getkotaX->fetch_assoc()){
	echo"<script>
	  $(function () {
	    $('#example1').DataTable();
	    $('#example".$gkX['kota']."').DataTable({
	      'paging': true,
	      'lengthChange': true,
	      'searching': true,
	      'ordering': true,

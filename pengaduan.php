...
<html>
	...
	<head>
		...
		<!-- Skin CSS file -->
		<link id="skin_css" rel="stylesheet" href="assets/css/skins/3.css">
		    	...
		    	<div class="pageContent">
		    		...
		    		<div class="page-title title-1">
						<div class="container">
							<div class="row">
								<h1>Pengaduan</h1>
								<h3>Formulir layanan pengaduan maysarakat terhadap layanan lembaga sertifikasi kompetensi</h3>
								
								<div class="breadcrumbs">
									<a href="index.php">Beranda</a><i class="fa fa-long-arrow-right main-color"></i><span>Layanan Pengaduan</span>
								</div>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-7 contact-form">
				    				<div class="heading">
										<h3 class="uppercase head-6"><span class="main-color">Layanan</span> Pengaduan Masyarakat</h3>
									</div>
									<?php
		                		$sql="SELECT * FROM `data_wilayah`";
						echo "<form action='pengaduansend.php' method='post'>
							...
							<div class='form-input'>
				    				<label>Sebagai siapa Anda mengirimkan pengaduan?<span class='red'>*</span></label>
								<select name='jenis_responden' class='form-control shape'  id='jenis_responden'>
								<option>--pilih--</option>";
								echo "<option value='Peserta'>Peserta</option>";
								echo "<option value='Asesor'>Asesor</option>";
								echo "<option value='Masyarakat'>Masyarakat Umum</option>";
								echo"</select>
							</div>
							<div class='form-input'>
				    				<label>Pesan Aduan<span class='red'>*</span></label><textarea name='aduan' placeholder='Tulis pesan aduan Anda' class='form-control shape' required></textarea>
							</div>
							<div class='form-input'>
							...
							<div class='form-input'>
								<input type='submit' value='KIRIM ADUAN' class='btn btn-md main-bg shape'>
							</div>
						</form>";
									?>
					    		...
					    		<div class="col-md-5">
									...
									<div class="msg-box warning-box shape">
										...
										<p>Layanan pengaduan ini ditujukan untuk menampung pengaduan dari asesi, asesor dan masyarakat atas ketidaksesuaian atau keluhan pelayanan Lembaga Sertifikasi Kompetensi. Setelah melakukan pengaduan, periksa inbox (kotak masuk) email anda, untuk menerima bukti pegaduan. Bila tidak terdapat pada inbox email anda silahkan periksa di SPAM email anda</p>
									</div>

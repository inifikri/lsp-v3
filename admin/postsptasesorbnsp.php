...
curl_setopt_array($curl0, array(
  CURLOPT_URL => 'https://konstruksi.bnsp.go.id/api/v1/jadwal/confirm',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
...
$datas=array(
	'jadwal_id' => $jadwal_id,
	'asesor_id' => $asesor_id,
	'url_surat_tugas' => $file_surattugas
);
...
curl_setopt_array($curl, array(
  CURLOPT_URL => 'https://konstruksi.bnsp.go.id/api/v1/jadwal/asesor/surat-tugas',
  CURLOPT_RETURNTRANSFER => true,
  CURLOPT_ENCODING => '',
  CURLOPT_MAXREDIRS => 10,
  CURLOPT_TIMEOUT => 30,
...
//=============================================
//echo "<script>alert('Penambahan Surat Tugas Asesor pada Jadwal di Sistem BNSP : ".$pesantampil.", silahkan cek di laman Jadwal BNSP'); window.location='media.php?module=jadwalasesmen';</script>";

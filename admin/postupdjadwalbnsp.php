...
if ($tokenxjum>0){
	...
	if (empty($tt['id_tuk_bnsp'])){
		...
		curl_setopt_array($curl, [
		  CURLOPT_URL => "https://konstruksi.bnsp.go.id/api/v1/jadwal/".$_POST['idjadwalbnsp'],
		  CURLOPT_RETURNTRANSFER => true,
		  CURLOPT_ENCODING => "",
		  CURLOPT_MAXREDIRS => 10,
		  CURLOPT_TIMEOUT => 30,
		...
		//=============================================
		echo "<script>alert('Ubah Jadwal di Sistem BNSP : ".$pesannya.", silahkan cek di laman Jadwal BNSP'); window.location='media.php?module=jadwalasesmen';</script>";

...
$username = mysqli_escape_string($conn,addslashes(strip_tags(htmlspecialchars($_POST['username'],ENT_QUOTES,'UTF-8'))));
$pass     = md5(mysqli_escape_string($conn,addslashes(strip_tags(htmlspecialchars($_POST['password'],ENT_QUOTES,'UTF-8')))));
...
$sqllogin="SELECT * FROM `users` WHERE `username`='$username' AND `password`='$pass' AND `blokir`='N'";
...
<div class='lockscreen-wrapper'>
  <div class='lockscreen-logo'>
    <a href='index.php'><b>Dashboard</b>Administrator</a>
  </div>
  <!-- User name -->

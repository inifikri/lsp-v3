...
echo "<script>alert('Perubahan data Peserta pada Jadwal di Sistem BNSP : ".$pesantampil.", silahkan cek di laman Jadwal BNSP'); window.location='media.php?module=jadwalasesmen';</script>";

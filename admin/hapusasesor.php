...
$ceka=$conn->query("SELECT * FROM `jadwal_asesor` WHERE `id_jadwal`='$idjdel' AND `id_asesor`='$idadel'");
...
if ($jumceka!=0){
	...
	$conn->query("DELETE FROM `jadwal_asesor` WHERE `id_jadwal`='$idjdel' AND `id_asesor`='$idadel'");

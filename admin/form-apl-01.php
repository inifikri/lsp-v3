...
$write->easyCell($_SESSION['no_induk'], 'align:L; valign:T; font-size:10; font-style:B; border:LBR;');
$write->printRow();
$write->easyCell('Tanda tangan/ 
...
$sqlcekttdadminapl01="SELECT * FROM `logdigisign` WHERE id_dokumen='$_GET[iddok]' AND `id_asesi`='$_SESSION[namauser]' AND `id_skema`='$sq[id]' AND nama_dokumen='FR-APL-01. FORMULIR PERMOHONAN SERTIFIKASI KOMPETENSI'";

				...
				if ($usia<101 && $as['pendidikan']>1 && $sydokpokok!='kosong'){
					...
					echo "<form role='form' method='POST' enctype='multipart/form-data'>
						...
						<tr><td colspan='2'>Tujuan Asesmen</td><td>
												<input type='radio' required='required' name='tujuan_sertifikasi' id='tujuansertifikasi1' value='Sertifikasi'"; if ($gstas['tujuan_sertifikasi']=="Sertifikasi"){echo " checked";}else{echo " checked";} echo ">
												Sertifikasi<br>
												<input type='radio' required='required' name='tujuan_sertifikasi' id='tujuansertifikasi2' value='Sertifikasi Ulang'"; if ($gstas['tujuan_sertifikasi']=="Sertifikasi Ulang"){echo " checked";}else{echo "";} echo ">
												Sertifikasi Ulang<br>
												<input type='radio' required='required' name='tujuan_sertifikasi' id='tujuansertifikasi3' value='Pengakuan Kompetensi Terkini (PKT)'"; if ($gstas['tujuan_sertifikasi']=="Pengakuan Kompetensi Terkini (PKT)"){echo " checked";}else{echo "";} echo ">
												Pengakuan Kompetensi Terkini (PKT)<br>
												<input type='radio' required='required' name='tujuan_sertifikasi' id='tujuansertifikasi4' value='Rekognisi Pembelajaran Lampau'"; if ($gstas['tujuan_sertifikasi']=="Rekognisi Pembelajaran Lampau"){echo " checked";}else{echo "";} echo ">
												Rekognisi Pembelajaran Lampau<br>
												<input type='radio' required='required' name='tujuan_sertifikasi' id='tujuansertifikasi5' value='Lainnya'"; if ($gstas['tujuan_sertifikasi']=="Lainnya"){echo " checked";}else{echo "";} echo ">
						...
						<div class='modal fade' id='myModal".$pm['id']."' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
							<div class='modal-dialog'>
								<div class='modal-content'>
									...
									<div class='modal-body'><embed src='foto_asesi/$pm[file]' width='100%'/>
									</div>
									<div class='modal-footer'>
										<button type='button' class='btn btn-default' data-dismiss='modal'>Tutup</button>
									</div>
				...
				switch ($asas['status']){
					...
					case "A":
						...
						case "BK":
							...
							$aksinya="<a class='btn btn-warning form-control' href='media.php?module=banding&idass=$asas[id]&idj=$asas[id_jadwal]'>Ajukan Banding</a>";
						break;
						case "TL":
				...
				<table id='example1' class='table table-bordered table-striped'>
					...
					while ($pm0=$asesiikut->fetch_assoc()){
						...
						if ($pm0['status_asesmen']=='BK'){
							echo "<a href='?module=banding&ida=$_SESSION[namauser]&idj=$pm0[id_jadwal]' class='btn btn-success btn-xs btn-block'>Ajukan Banding Asesmen (FORM-AK-04)</a><br>";
							echo "<a href='asesor/form-fr-ak-04.php?ida=$_SESSION[namauser]&idj=$pm0[id_jadwal]' class='btn btn-warning btn-xs btn-block'>Unduh Form Banding Asesmen (FORM-AK-04)</a>";
						}
						echo"</td></tr>";
						$no++;
					}
	...
	{				
		...
		if ($cekak01>0){
			...
			if(empty($_POST['signed'])){
				...
				$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
				$alamatip=$_SERVER['REMOTE_ADDR'];
				$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.AK.04. BANDING ASESMEN','$_SESSION[namalengkap]','$file','$alamatip')";
				$conn->query($sqlinputdigisign);
				echo "<div class='alert alert-success alert-dismissible'>
				<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
				<h4><i class='icon fa fa-check'></i> Permohonan Banding Anda berhasil disimpan</h4>
          ...
          <div class='box'>
			...
			<form role='form' method='POST' enctype='multipart/form-data'>
				<table id='example1' class='table table-bordered table-striped'>
					...
					<label>
						<input type='radio' name='pertanyaan1' id='pertanyaan1_1' value='1'"; if ($cbd['pertanyaan1']=='1'){echo " checked";}else{echo "";}echo">YA &nbsp;&nbsp;&nbsp;
					</label>
					<label>
						<input type='radio' name='pertanyaan1' id='pertanyaan1_2' value='0'"; if ($cbd['pertanyaan1']=='0'){echo " checked";}else{echo "";}echo">TIDAK
					</label>
					</td>";
					echo "<tr><td colspan='3'>Apakah Anda telah mendiskusikan Banding dengan Asesor?</td><td colspan='2'>
					<label>
						<input type='radio' name='pertanyaan2' id='pertanyaan2_1' value='1'"; if ($cbd['pertanyaan1']=='1'){echo " checked";}else{echo "";}echo">YA &nbsp;&nbsp;&nbsp;
					</label>
					<label>
						<input type='radio' name='pertanyaan2' id='pertanyaan2_2' value='0'"; if ($cbd['pertanyaan1']=='0'){echo " checked";}else{echo "";}echo">TIDAK
					</label>
					</td>";
					echo "<tr><td colspan='3'>Apakah Anda mau melibatkan 'orang lain' membantu Anda dalam Proses Banding?</td><td colspan='2'>
					<label>
						<input type='radio' name='pertanyaan3' id='pertanyaan3_1' value='1'"; if ($cbd['pertanyaan1']=='1'){echo " checked";}else{echo "";}echo">YA &nbsp;&nbsp;&nbsp;
					</label>
					<label>
						<input type='radio' name='pertanyaan3' id='pertanyaan3_2' value='0'"; if ($cbd['pertanyaan1']=='0'){echo " checked";}else{echo "";}echo">TIDAK
					</label>
					</td>";
					...
					<textarea name='alasan_banding' class='form-control' placeholder='isi alasan Anda mengajukan banding di sini'>"; if (!empty($cbd['alasan_banding'])){echo "$cbd[alasan_banding]";}else{echo "";}echo"</textarea></td>";
			...
			// cek tandatangan digital
				...
				echo "<div class='box-footer bg-black'>
					...
					<div class='col-md-4 col-sm-12 col-xs-12'>
							<a href='asesor/form-fr-ak-04.php?ida=$_SESSION[namauser]&idj=$_GET[idj]' class='btn btn-primary form-control'>Unduh Formulir</a>
					</div>
					<div class='col-md-4 col-sm-12 col-xs-12'>
      ...
      <div class='row'>
		...
		<div class='box-body'>";
				  ...
				  <div class='col-md-6'>
					<div class='form-group'>
						...
						<select name='kategori' class='form-control' id='kategori'>";
							...
							$getpersyaratanpokok=$conn->query($sqlgetpersyaratanpokok);
							while ($pspk=$getpersyaratanpokok->fetch_assoc()){
								echo "<option value='$pspk[shortcode]'>$pspk[persyaratan] "; if ($pspk['wajib']=='Y'){echo "(wajib)";}else{echo "(tambahan)";} echo "</option>";
							}
						echo "</select>";
					echo"</div>
				  </div>
			...
			while ($pspk=$getpersyaratanpokok->fetch_assoc()){
				...
				echo "<tr><td>$nodoc</td><td><b>Dokumen $pspk[persyaratan]</b> ("; if ($pspk['wajib']=='Y'){echo "wajib";}else{echo "tambahan";} echo")<br>Dokumen : <b><a href='#myModal".$shorcodenya."' data-toggle='modal' data-id='".$shorcodenya."'>$pm[$shorcodenya]</a></b></td><td>"; 
...
elseif ($_GET['module']=='form-apl-02-el'){
	...
	{				
    	...
    	if(empty($_POST['signed'])){
			...
			$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
			$alamatip=$_SERVER['REMOTE_ADDR'];
			$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.APL.02. ASESMEN MANDIRI','$rowAgen[nama]','$file','$alamatip')";
    			$conn->query($sqlinputdigisign);
			echo "<div class='alert alert-success alert-dismissible'>
			<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
			<h4><i class='icon fa fa-check'></i> Jawaban berhasil disimpan</h4>
					...
					<div class='box-body'>
						...
						<table id='example9' class='table table-bordered table-striped'>
							<tr><td rowspan='4' width='25%'>Bukti yang akan dikumpulkan</td><td>";
								echo "<input type='checkbox' class='flat-red' name='checkboxVP' id='optionsVP' value='1'";if ($jjw['VP']=="1"){echo "checked";}else{echo "";} echo" disabled> TL : Verifikasi Portfolio";
								echo "</td><td>";
								echo "<input type='checkbox' class='flat-red' name='checkboxCL' id='optionsCL' value='1'";if ($jjw['CL']=="1"){echo "checked";}else{echo "";} echo" disabled> L : Observasi Langsung";
								echo "</td>
							</tr>
							<tr><td colspan='2'>";
								echo "<input type='checkbox' class='flat-red' name='checkboxDPT' id='optionsDPT' value='1'";if ($jjw['DPT']=="1"){echo "checked";}else{echo "";} echo" disabled> T : Hasil Tes Tulis";
								echo "</td>
							</tr>
							<tr><td colspan='2'>";
								echo "<input type='checkbox' class='flat-red' name='checkboxDPL' id='optionsDPL' value='1'";if ($jjw['DPL']=="1"){echo "checked";}else{echo "";} echo" disabled> L : Hasil Tes Lisan";
								echo "</td>
							</tr>
							<tr><td colspan='2'>";
								echo "<input type='checkbox' class='flat-red' name='checkboxPW' id='optionsPW' value='1'";if ($jjw['PW']=="1"){echo "checked";}else{echo "";} echo" disabled> L : Hasil Wawancara";
								echo "</td>
							</tr>
						</table>
						<table id='example9' class='table table-bordered table-striped'>
						...
						<p><b>Asesi :</b><br />
						<input type='checkbox' class='flat-red' name='persetujuan' id='optionsPersetujuan' value='Y'";if ($jjw['persetujuan_asesi']=="Y"){echo "checked";}else{echo "";} echo" required> Saya setuju mengikuti asesmen dengan pemahaman bahwa informasi yang dikumpulkan hanya digunakan untuk pengembangan profesional dan hanya dapat diakses oleh orang tertentu saja.
						</p>";
					// cek tandatangan digital
					$url = "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
					$iddokumen=md5($url);
            	...
            	<div class='box-body'>
					...
					<table id='example9' class='table table-bordered table-striped'>
						...
						while ($unk2=$getunitkompetensi2->fetch_assoc()){
							...
							echo "<td><input type='checkbox' class='flat-red' name='checkboxCL".$unk2['id']."' id='optionsCL".$unk2['id']."' value='1'";if ($jjw['CL']=="1"){echo "checked";}else{echo "";} echo" disabled></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxVP".$unk2['id']."' id='optionsVP".$unk2['id']."' value='1'";if ($jjw['VP']=="1"){echo "checked";}else{echo "";} echo" disabled></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxPW".$unk2['id']."' id='optionsPW".$unk2['id']."' value='1'";if ($jjw['PW']=="1"){echo "checked";}else{echo "";} echo" disabled></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxDPL".$unk2['id']."' id='optionsDPL".$unk2['id']."' value='1'";if ($jjw['DPL']=="1"){echo "checked";}else{echo "";} echo" disabled></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxDPT".$unk2['id']."' id='optionsDPT".$unk2['id']."' value='1'";if ($jjw['DPT']=="1"){echo "checked";}else{echo "";} echo" disabled></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxCUP".$unk2['id']."' id='optionsCUP".$unk2['id']."' value='1'";if ($jjw['CUP']=="1"){echo "checked";}else{echo "";} echo" disabled></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxLainnya".$unk2['id']."' id='optionsLainnya".$unk2['id']."' value='1'";if ($jjw['Lainnya']=="1"){echo "checked";}else{echo "";} echo" disabled></td>";
							echo "</tr>";
						}
					echo "</table>
					<table id='example9' class='table table-bordered table-striped'>
	...
	{			
		...
		if ($cekak01>0){
			...
			if(empty($_POST['signed'])){
				...
				$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
				$alamatip=$_SERVER['REMOTE_ADDR'];
				$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.AK.03. UMPAN BALIK DAN CATATAN ASESMEN','$_SESSION[namalengkap]','$file','$alamatip')";
				$conn->query($sqlinputdigisign);
				echo "<div class='alert alert-success alert-dismissible'>
				<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
				<h4><i class='icon fa fa-check'></i> Umpan Balik dan Catatan Asesmen berhasil disimpan</h4>
            	...
            	<div class='box-body'>
					...
					<table id='example9' class='table table-bordered table-striped'>
						...
						<tr><td>Saya mendapatkan penjelasan yang cukup memadai mengenai proses asesmen/ uji kompetensi</td><td><div class='radio'>";
							echo "<input type='radio' class='flat-red' name='radioK1' id='optionsRadio1K1' value='1'";if ($jumjjwx>0){if ($jjw['K1']=="1"){echo "checked";}else{echo "";}} echo"> Ya<br />";
							echo "<input type='radio' class='flat-red' name='radioK1' id='optionsRadio2K1' value='0'";if ($jumjjwx>0){if ($jjw['K1']=="0"){echo "checked";}else{echo "";}} echo"> Tidak";
							echo "</div></td><td><textarea name='catatanK1' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanK1]";} echo "</textarea></td>
						</tr>
						<tr><td>Saya diberikan kesempatan untuk mempelajari standar kompetensi yang akan diujikan dan menilai diri sendiri terhadap pencapaiannya</td><td><div class='radio'>";
							echo "<input type='radio' class='flat-red' name='radioK2' id='optionsRadio1K2' value='1'";if ($jumjjwx>0){if ($jjw['K2']=="1"){echo "checked";}else{echo "";}} echo"> Ya<br />";
							echo "<input type='radio' class='flat-red' name='radioK2' id='optionsRadio2K2' value='0'";if ($jumjjwx>0){if ($jjw['K2']=="0"){echo "checked";}else{echo "";}} echo"> Tidak";
							echo "</div></td><td><textarea name='catatanK2' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanK2]";} echo "</textarea></td>
						</tr>
						<tr><td>Asesor memberikan kesempatan untuk mendiskusikan/menegosiasikan metoda, instrumen dan sumber asesmen serta jadwal asesmen</td><td><div class='radio'>";
							echo "<input type='radio' class='flat-red' name='radioK3' id='optionsRadio1K3' value='1'";if ($jumjjwx>0){if ($jjw['K3']=="1"){echo "checked";}else{echo "";}} echo"> Ya<br />";
							echo "<input type='radio' class='flat-red' name='radioK3' id='optionsRadio2K3' value='0'";if ($jumjjwx>0){if ($jjw['K3']=="0"){echo "checked";}else{echo "";}} echo"> Tidak";
							echo "</div></td><td><textarea name='catatanK3' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanK3]";} echo "</textarea></td>
						</tr>
						<tr><td>Asesor berusaha menggali seluruh bukti pendukung yang sesuai dengan latar belakang pelatihan dan pengalaman yang saya miliki</td><td><div class='radio'>";
							echo "<input type='radio' class='flat-red' name='radioK4' id='optionsRadio1K4' value='1'";if ($jumjjwx>0){if ($jjw['K4']=="1"){echo "checked";}else{echo "";}} echo"> Ya<br />";
							echo "<input type='radio' class='flat-red' name='radioK4' id='optionsRadio2K4' value='0'";if ($jumjjwx>0){if ($jjw['K4']=="0"){echo "checked";}else{echo "";}} echo"> Tidak";
							echo "</div></td><td><textarea name='catatanK4' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanK4]";} echo "</textarea></td>
						</tr>
						<tr><td>Saya sepenuhnya diberikan kesempatan untuk mendemonstrasikan kompetensi yang saya miliki selama asesmen</td><td><div class='radio'>";
							echo "<input type='radio' class='flat-red' name='radioK5' id='optionsRadio1K5' value='1'";if ($jumjjwx>0){if ($jjw['K5']=="1"){echo "checked";}else{echo "";}} echo"> Ya<br />";
							echo "<input type='radio' class='flat-red' name='radioK5' id='optionsRadio2K5' value='0'";if ($jumjjwx>0){if ($jjw['K5']=="0"){echo "checked";}else{echo "";}} echo"> Tidak";
							echo "</div></td><td><textarea name='catatanK5' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanK5]";} echo "</textarea></td>
						</tr>
						<tr><td>Saya mendapatkan penjelasan yang memadai mengenai keputusan asesmen</td><td><div class='radio'>";
							echo "<input type='radio' class='flat-red' name='radioK6' id='optionsRadio1K6' value='1'";if ($jumjjwx>0){if ($jjw['K6']=="1"){echo "checked";}else{echo "";}} echo"> Ya<br />";
							echo "<input type='radio' class='flat-red' name='radioK6' id='optionsRadio2K6' value='0'";if ($jumjjwx>0){if ($jjw['K6']=="0"){echo "checked";}else{echo "";}} echo"> Tidak";
							echo "</div></td><td><textarea name='catatanK6' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanK6]";} echo "</textarea></td>
						</tr>
						<tr><td>Asesor memberikan umpan balik yang mendukung setelah asesmen serta tindak lanjutnya</td><td><div class='radio'>";
							echo "<input type='radio' class='flat-red' name='radioK7' id='optionsRadio1K7' value='1'";if ($jumjjwx>0){if ($jjw['K7']=="1"){echo "checked";}else{echo "";}} echo"> Ya<br />";
							echo "<input type='radio' class='flat-red' name='radioK7' id='optionsRadio2K7' value='0'";if ($jumjjwx>0){if ($jjw['K7']=="0"){echo "checked";}else{echo "";}} echo"> Tidak";
							echo "</div></td><td><textarea name='catatanK7' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanK7]";} echo "</textarea></td>
						</tr>
						<tr><td>Asesor bersama saya mempelajari semua dokumen asesmen serta menandatanganinya</td><td><div class='radio'>";
							echo "<input type='radio' class='flat-red' name='radioK8' id='optionsRadio1K8' value='1'";if ($jumjjwx>0){if ($jjw['K8']=="1"){echo "checked";}else{echo "";}} echo"> Ya<br />";
							echo "<input type='radio' class='flat-red' name='radioK8' id='optionsRadio2K8' value='0'";if ($jumjjwx>0){if ($jjw['K8']=="0"){echo "checked";}else{echo "";}} echo"> Tidak";
							echo "</div></td><td><textarea name='catatanK8' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanK8]";} echo "</textarea></td>
						</tr>
						<tr><td>Saya mendapatkan jaminan kerahasiaan hasil asesmen serta penjelasan penanganan dokumen asesmen</td><td><div class='radio'>";
							echo "<input type='radio' class='flat-red' name='radioK9' id='optionsRadio1K9' value='1'";if ($jumjjwx>0){if ($jjw['K9']=="1"){echo "checked";}else{echo "";}} echo"> Ya<br />";
							echo "<input type='radio' class='flat-red' name='radioK9' id='optionsRadio2K9' value='0'";if ($jumjjwx>0){if ($jjw['K9']=="0"){echo "checked";}else{echo "";}} echo"> Tidak";
							echo "</div></td><td><textarea name='catatanK9' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanK9]";} echo "</textarea></td>
						</tr>
						<tr><td>Asesor menggunakan keterampilan komunikasi yang efektif selama asesmen</td><td><div class='radio'>";
							echo "<input type='radio' class='flat-red' name='radioK10' id='optionsRadio1K10' value='1'";if ($jumjjwx>0){if ($jjw['K10']=="1"){echo "checked";}else{echo "";}} echo"> Ya<br />";
							echo "<input type='radio' class='flat-red' name='radioK10' id='optionsRadio2K10' value='0'";if ($jumjjwx>0){if ($jjw['K10']=="0"){echo "checked";}else{echo "";}} echo"> Tidak";
							echo "</div></td><td><textarea name='catatanK10' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanK10]";} echo "</textarea></td>
						</tr>						
					</table>
					<p><b>Catatan/ Komentar lainnya (apabila ada) :</b><br />
					<textarea name='catatanL' class='form-control'>";if ($jumjjwx>0){echo "$jjw[catatanL]";} echo "</textarea>
					<p><b>Asesi :</b>
					</p>";
				// cek tandatangan digital
				/* $url = "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
						...
						while ($unkb=$getunitkompetensib->fetch_assoc()){
							...
							while ($gpp=$getpertanyaan->fetch_assoc()){
								if (!empty($gpp['pertanyaan'])){
									...
									<input type='radio' name='rekomendasi$gpp[id]' id='rekomendasi$gpp[id]1' value='K' ";if ($jjw['rekomendasi']=='K'){echo " checked";}else{echo "";} echo " disabled>&nbsp;Kompeten<br>
									<input type='radio' name='rekomendasi$gpp[id]' id='rekomendasi$gpp[id]2' value='BK' ";if ($jjw['rekomendasi']=='BK'){echo " checked";}else{echo "";} echo " disabled>&nbsp;Belum Kompeten</td></tr>
						...
						while ($unk=$getsoal->fetch_assoc()){
							...
							if ($jcjwb>0){
								echo "<div class='radio'>
									<input type='radio' name='optionsRadios$unk[id]' id='options1$unk[id]' value='a'";if ($cjwb['jawaban']=='a'){echo " checked";} echo ">
									 $unk[pilihan_a]</div>";
								echo "<div class='radio'>
									<input type='radio' name='optionsRadios$unk[id]' id='options2$unk[id]' value='b'";if ($cjwb['jawaban']=='b'){echo " checked";} echo ">
									 $unk[pilihan_b]</div>";
								echo "<div class='radio'>
									<input type='radio' name='optionsRadios$unk[id]' id='options3$unk[id]' value='c'";if ($cjwb['jawaban']=='c'){echo " checked";} echo ">
									 $unk[pilihan_c]</div>";
								if (!empty($unk['pilihan_d'])){
									echo "<div class='radio'>
										<input type='radio' name='optionsRadios$unk[id]' id='options4$unk[id]' value='d'";if ($cjwb['jawaban']=='d'){echo " checked";} echo ">
										 $unk[pilihan_d]</div>";
								}
								if (!empty($unk['pilihan_e'])){
									echo "<div class='radio'>
										<input type='radio' name='optionsRadios$unk[id]' id='options5$unk[id]' value='e'";if ($cjwb['jawaban']=='e'){echo " checked";} echo ">
										 $unk[pilihan_e]</div>";
								}
							}else{
								echo "<div class='radio'>

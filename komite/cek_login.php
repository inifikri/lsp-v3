...
$sqllogin="SELECT * FROM `komite` WHERE `no_ktp`='$username' AND `password`='$pass' AND `aktif`='Y' OR `no_hp`='$username' AND `password`='$pass' AND `aktif`='Y'";
...
$sqllogin2="SELECT * FROM `komite` WHERE `no_ktp`='$_POST[username]'";
...
<div class='lockscreen-wrapper'>
  <div class='lockscreen-logo'>
    <a href='index.php'><b>Dashboard</b>Komite Teknis</a>
  </div>
  <!-- User name -->
  ...
  <div class='lockscreen-item'>
    ...
    <div class='lockscreen-image'>
      <img src='../foto_komite/$rf[foto]' alt='User Image'>
    </div>
    <!-- /.lockscreen-image -->

<?php
    $rsql="SELECT * FROM `komite` WHERE `no_ktp`='$_SESSION[namauser]'";
	$getuser=$conn->query($rsql);
	$r=$getuser->fetch_assoc();
	echo "<!-- Content Header (Page header) -->
    <section class='content-header'>
      <h1>
        Ubah Kata Sandi (Password) Komite
        ...
        <div class='col-xs-12'>
          <div class='box'>
            <div class='box-header'>
              <h3 class='box-title'>Ubah Kata Sandi/Password Komite $_SESSION[namauser]</h3>
            </div>
            <!-- /.box-header -->
            <div class='box-body'>

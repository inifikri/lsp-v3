		    ...
		    <div id="contentWrapper">
		    	...
		    	<div class="pageContent">
					...
					<div class="section">
						<div class="container">
							<div class="row">
								<h1>Persyaratan Calon Asesi</h1>
								<h3>Persyaratan peserta uji kompetensi sesuai skema uji kompetensi</h3>
								
								<div class="breadcrumbs">
									<a href="index.php">Beranda</a><i class="fa fa-long-arrow-right main-color"></i><span>Persyaratan Calon Asesi</span>
								</div>
								<div class="col-md-12">
								    <div class="panel-group accordion style-4" id="accordion-5" role="tablist">
									<?php
									$nofq=1;
									$sqlgetkategoriid="SELECT * FROM `skema_kkni` ORDER BY `id` ASC";
									$getkategoriid=$conn->query($sqlgetkategoriid);
									while ($katid=$getkategoriid->fetch_assoc()){
										echo "<div class='panel'>
											<div class='panel-heading' role='tab' id='heading-$nofq'>
												<h4 class='panel-title'>
													<a role='button' class='shape' data-toggle='collapse' data-parent='#accordion-5' href='#acc-$nofq' aria-expanded='true' aria-controls='acc-$nofq'><i class='fa fa-desktop main-color'></i>Skema $katid[judul]</a>
												</h4>
											</div>";
										$sqlgetfaq="SELECT * FROM `skema_persyaratan` WHERE `id_skemakkni`='$katid[id]'";

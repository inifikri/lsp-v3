						...
						<div class="container">
							<div class="row">
								<div class="breadcrumbs">
									<a href="index.php">Beranda</a><i class="fa fa-long-arrow-right main-color"></i><span>Tempat Uji Kompetensi</span>
								</div>
							</div>
						</div>
					</div>
					...
					<div class="section">
						<div class="container">
							<div class="row">										
								<div class="col-md-12">
									<h1>TUK</h1>
									<h3>Tempat Uji Kompetensi Pelaksanaan Asesmen Uji Kompetensi</h3>								    <div class="panel-group accordion style-4" id="accordion-5" role="tablist">
									<?php
									$nofq=1;
									$sqlgetkategoriid="SELECT * FROM `tuk` ORDER BY `id` ASC";
										...
										echo "<div class='panel'>
											<div class='panel-heading' role='tab' id='heading-$nofq'>
												<h4 class='panel-title'>
													<a role='button' class='shape' data-toggle='collapse' data-parent='#accordion-5' href='#acc-$nofq' aria-expanded='true' aria-controls='acc-$nofq'><i class='fa fa-desktop main-color'></i>$pm[nama]</a>
												</h4>
											</div>";
																				
											echo "<div id='acc-$nofq' class='panel-collapse collapse in' role='tabpanel' aria-labelledby='heading-$nofq'>
												<div class='panel-body'>";
													$sqltuk="SELECT * FROM `tuk` WHERE `id`='$pm[id]'";
						...
						$jumjadwal=$cekterjadwal->num_rows;
													$sqlgetkotwil="SELECT * FROM `data_wilayah` WHERE `id_wil`='$tt[id_wilayah]'";
													$getkotwil=$conn->query($sqlgetkotwil);
													$kotwil=$getkotwil->fetch_assoc();
													$kecamatannya=trim($kotwil['nm_wil']);
													...
													$kotanya=trim($kotwil2['nm_wil']);
													$sqlgetkotwil3="SELECT * FROM `data_wilayah` WHERE `id_wil`='$kotwil2[id_induk_wilayah]'";
													$getkotwil3=$conn->query($sqlgetkotwil3);
													$kotwil3=$getkotwil3->fetch_assoc();
													$provinsinya=trim($kotwil3['nm_wil']);

						echo "<br>Tempat Uji Kompetensi :<br><b>$tt[nama]</b><br>$tt[alamat] $tt[kelurahan],<br>$kecamatannya, $kotanya, $provinsinya</p><br>Jenis TUK : $jt[jenis_tuk]<br>Terjadwal : $jumjadwal Asesmen";
						echo "<br>$li[nama] ($li[jenis_lsp])";
						$namaskkni=$conn->query("SELECT * FROM `skkni` WHERE `id`='$pm[id_skkni]'");
						$nsk=$namaskkni->fetch_assoc();
						echo "<br>SKKNI : $nsk[nama]";
						echo "<br><p>Penanggungjawab : $pm[penanggungjawab]</p>";

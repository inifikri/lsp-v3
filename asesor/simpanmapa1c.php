...
$sqlgetmapa12="SELECT * FROM `skema_mapa1a` WHERE `id_skemakkni`='$_POST[id_skema]' ORDER BY `id` ASC";
$getmapa12=$conn->query($sqlgetmapa12);
$gtmapa12=$getmapa12->fetch_assoc();
$jumgtmapa12=$getmapa12->num_rows;

if ($jumgtmapa12==0){
	$sqlskemamapa1="INSERT INTO `skema_mapa1a`(`id_skemakkni`, `modkon1a`, `modkon1a_ket`, `modkon1b`, `modkon1b_ket`, `modkon2`, `modkon2_ket`, `modkon3`, `modkon3_ket`, `modkon4`, `modkon4_ket`, `konfirm1`, `konfirm1_ket`, `konfirm2`, `konfirm2_ket`, `konfirm3`, `konfirm3_ket`, `konfirm4`, `konfirm4_ket`) VALUES ('$id_skemakkni', '$modkon1a', '$modkon1a_ket', '$modkon1b', '$modkon1b_ket', '$modkon2', '$modkon2_ket', '$modkon3', '$modkon3_ket', '$modkon4', '$modkon4_ket', '$konfirm1', '$konfirm1_ket', '$konfirm2', '$konfirm2_ket', '$konfirm3', '$konfirm3_ket', '$konfirm4', '$konfirm4_ket')";
	...
	$sqlskemamapa1="UPDATE `skema_mapa1a` SET
		...
		WHERE `id_skemakkni`='$id_skemakkni'";
	$conn->query($sqlskemamapa1);
}
echo "<script>alert('Bagian 3 MAPA-01 Telah Tersimpan/Terupdate'); window.location = 'media.php?module=jadwalasesmen'</script>";

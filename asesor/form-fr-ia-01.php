	...
	while ($el=$getelemen->fetch_assoc()){
		...
		while($kr=$getkriteria->fetch_assoc()){
			if ($nokrit==1){
				...
				$write->easyCell($cbkt['benchmark'], 'align:L; valign:T; border:TRB; rowspan:'.$jumkukelemen0.'; font-size:9;');
				switch ($cbkt['keputusan']){
				default:
					$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:T; rowspan:'.$jumkukelemen0.'; border:TRB;');
					$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:T; rowspan:'.$jumkukelemen0.'; border:TRB;');
				break;
				case "K":
					$write->easyCell('', 'img:../images/checked.jpg, w5, h5; align:C; valign:T; rowspan:'.$jumkukelemen0.'; border:TRB;');
					$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:T; rowspan:'.$jumkukelemen0.'; border:TRB;');
				break;
				case "BK":
					$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:T; rowspan:'.$jumkukelemen0.'; border:TRB;');
				...
				$write->easyCell($cbkt['penilaian_lanjut'], 'align:L; valign:T; border:TRB; rowspan:'.$jumkukelemen0.'; font-size:9;');
				$write->printRow();
			}else{
				$nokrnya=$noel.'.'.$nokrit.'.';
...
$write->easyCell($getk['umpan_balik'], 'align:L; valign:T; border:TRB;');
$write->printRow();
$write->endTable(5);
...
//output file pdf
$fileoutputnya="FR-IA-01-".$skemakkni."-".$_GET['idj']."-".$_GET['ida'].".pdf";

...
elseif ($_GET['module'] == 'verifikasituk') {
	...
	while ($pm0x = $lsp->fetch_assoc()) {
		...
		if ($terjadwal > 0) {
			...
			while ($ns = $sqlgetskkni->fetch_assoc()) {
				...
				$ns2 = $sqlgetskkni2->fetch_assoc();
				$sqlgetskkni3 = $conn->query("SELECT * FROM `tukjarakjauh_doc` WHERE `asesi_id`='$pm[no_pendaftaran]' AND `skema_id`='$ns[skema_id]'");
				$ns3 = $sqlgetskkni3->num_rows;
				...
				if ($ns3 == 0) {
					...
					echo "<li>Persyaratan : <span class='text-green'><b>Telah mengunggah $ns3 Dokumen</b></span>
									<a href='?module=veriftukjarakjauh&idas=$ns[id]&id=$ns[skema_id]&ida=$pm[no_pendaftaran]' class='btn btn-info btn-xs' target='_blank' title='Lakukan Verifikasi/Persetujuan Dokumen yang diunggah Asesi'>Verifikasi</a></li>";
				}
				switch ($ns['status']) {
					case "A":
	...
	$qtukjarakjauh = "SELECT * FROM asesi_tukjarakjauh WHERE asesi_id='$_GET[ida]' AND skema_id='$_GET[id]'";
	...
	if (isset($_REQUEST['setujuiasesmen'])) {
		$tgl_daftar = date("Y-m-d");
		$querydas = "UPDATE `asesi_tukjarakjauh` SET `status`='A', `asesor_id`='$_SESSION[namauser]', `tgl_verifikasi`='$tgl_daftar' WHERE `id`='$_GET[idas]' AND `asesi_id`='$_GET[ida]' AND `skema_id`='$_GET[id]'";
		$querycek = "SELECT * FROM `asesi_tukjarakjauh` WHERE `id`='$_GET[idas]' AND `asesi_id`='$_GET[ida]' AND `skema_id`='$_GET[id]' AND `status`='A'";
		$resultc = $conn->query($querycek);
		$row_cnt = $resultc->num_rows;
	...
	if (isset($_REQUEST['tolakasesmen'])) {
		$tgl_daftar = date("Y-m-d");
		$querydas = "UPDATE `asesi_tukjarakjauh` SET `status`='R' WHERE `id`='$_GET[idas]' AND `asesi_id`='$_GET[ida]' AND `skema_id`='$_GET[id]'";
		$querycek = "SELECT * FROM `asesi_tukjarakjauh` WHERE `id`='$_GET[idas]' AND `asesi_id`='$_GET[ida]' AND `skema_id`='$_GET[id]' AND `status`='R'";
		$resultc = $conn->query($querycek);
		$row_cnt = $resultc->num_rows;
		$folderPath = "../foto_tandatangan/";
		if (empty($_POST['signed'])) {
								...
								<table id="example" class="table table-bordered table-striped">
									...
									<tbody>
										...
										while ($pm = $lsp->fetch_assoc()) {
											...
											echo "</td><td>$pm[persyaratan]</td></tr>";
											/*echo "<td><form name='frm' method='POST' role='form' enctype='multipart/form-data'>
						<input type='hidden' name='iddelsy' value='$pm[id]'><input type='submit' name='hapussy' onclick='return confirmation()' class='btn btn-danger btn-xs' title='Hapus' value='Hapus'></form></td></tr>"; */
											$no++;
										}
										echo "</tbody>
			</table>
	...
	<div class='panel box box-success'>
	  ...
	  <div id='collapseThree' class='panel-collapse collapse in'>
		<div class='box-body'>";
			...
			Usia Calon Asesi adalah <b>$usia tahun</b>, $syaratusia<br>
			Pendidikan terakhir Calon Asesi adalah <b>$pdas[jenjang_pendidikan]</b>, $syaratpend<br></p>";
										$querycekasesmen = "SELECT * FROM `asesi_tukjarakjauh` WHERE `id`='$_GET[idas]' AND `asesi_id`='$_GET[ida]' AND `skema_id`='$_GET[id]' AND `status`='R'";
										$cekasesmen = $conn->query($querycekasesmen);
										$asesmen = $cekasesmen->num_rows;
										if ($asesmen <> 0) {
											echo "<div class='alert alert-danger alert-dismissible'>
				...
				Permohonan asesmen Asesi pada skema ini dinyatakan ditolak<b></b></div>";
										...
										$querycekasesmen1 = "SELECT * FROM `asesi_tukjarakjauh` WHERE `id`='$_GET[idas]' AND `asesi_id`='$_GET[ida]' AND `skema_id`='$_GET[id]' AND `status`='A'";
										$cekasesmen1 = $conn->query($querycekasesmen1);
										$asesmen1 = $cekasesmen1->num_rows;
										if ($asesmen1 <> 0) {
											echo "<div class='alert alert-success alert-dismissible'>
				...
				<tbody>
					...
					<tbody>";
											$no = 1;
											$sqlasesidoc = "SELECT * FROM `tukjarakjauh_doc` WHERE `asesi_id`='$as[no_pendaftaran]' AND `skema_id`='$_GET[id]' ORDER BY `id` DESC";
											$asesidoc = $conn->query($sqlasesidoc);
											while ($pm = $asesidoc->fetch_assoc()) {
												switch ($pm['status']) {
													default:
								...
								"; */
												...
												$sqlcekrevdoc = "SELECT * FROM `tukjarakjauh_doc` WHERE `asesi_id`='$as[no_pendaftaran]' AND `skema_id`='$_GET[id]'";
					...
					<table id='table-example' class='table table-bordered table-striped'>
						<tr><td>Nama</td><td>$_SESSION[namalengkap]</td></tr>";
											...
											$querycekasesmen2 = "SELECT * FROM `tukjarakjauh_doc` WHERE `id`='$_GET[idas]' AND `asesi_id`='$_GET[ida]' AND `skema_id`='$_GET[id]'";
											...
											$sqlasesidoc = "SELECT * FROM `tukjarakjauh_doc` WHERE `asesi_id`='$_GET[ida]' AND `skema_id`='$_GET[id]' AND `status`!='R'";
											$asesidoc = $conn->query($sqlasesidoc);
											$jumpm = $asesidoc->num_rows;
											$sqlasesidoca = "SELECT * FROM `tukjarakjauh_doc` WHERE `asesi_id`='$_GET[ida]' AND `skema_id`='$_GET[id]' AND `status`='A'";
											...
											$qasesiasesmen = $conn->query("SELECT * FROM asesi_tukjarakjauh WHERE `asesi_id`='$_GET[ida]' AND `skema_id`='$_GET[id]'")->fetch_assoc();
											$url = "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
											$iddokumen = md5($url);
											$sqlcektandatangan = "SELECT * FROM `logdigisign` WHERE id_asesi='$_SESSION[namauser]' AND id_skema='$_GET[id]' AND nama_dokumen='FR-TUK.FORMULIR PERMOHONAN TUK JARAK JAUH' AND penandatangan='$_SESSION[namalengkap]' ORDER BY `id` DESC";
							  ...
							  <span class='caret'></span>
                  					...
                  					<ul class='dropdown-menu' role='menu'>
                 					  ...
                 					  <li><a href='form-fr-ak-02.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='FORMULIR REKAMAN ASESMEN KOMPETENSI' target='_blank'>Unduh Formulir FR-AK-02</a></li>
                  					  ...
                  					  <li><a href='form-fr-ia-03.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='PERTANYAAN UNTUK MENDUKUNG OBSERVASI' target='_blank'>Unduh Formulir FR-IA-03</a></li>
			...
			<ol>
				...
				<h3>Rekomendasi :</h3>
					...
					Asesmen tidak dapat dilanjutkan<br>
										...
										$url = "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
										$iddokumen = md5($url);
										$sqlcektandatangan = "SELECT * FROM `logdigisign` WHERE id_asesi='$_SESSION[namauser]' AND id_skema='$jd[id_skemakkni]' ORDER BY `id` DESC";
										$cektandatangan = $conn->query($sqlcektandatangan);
										$jumttd = $cektandatangan->num_rows;
										$ttdx = $cektandatangan->fetch_assoc();
										if ($jumttd > 0) {
      ...
      <ol class='breadcrumb'>
        ...
        <li class='active'>FR.AK.05</li>
				...
				<a class='btn btn-warning form-control' href='?module=pesertaasesmen&idj=$_GET[idj]'>Kembali</a></div>";
													...
													$escaped_url = htmlspecialchars($url, ENT_QUOTES, 'UTF-8');
													$alamatip = $_SERVER['REMOTE_ADDR'];
													$sqlinputdigisign = "INSERT INTO `logdigisign`(`id_dokumen`, id_skema, id_asesi, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$sk[id]','$_SESSION[namauser]','$escaped_url','FR.AK.05. LAPORAN ASESMEN','$_SESSION[namalengkap]','$file','$alamatip')";
													$conn->query($sqlinputdigisign);
													echo "<div class='alert alert-success alert-dismissible'>
				<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
				<h4><i class='icon fa fa-check'></i> Laporan Asesmen berhasil disimpan</h4>
      ...
      <ol class='breadcrumb'>
        ...
        <li class='active'>FR.AK.06</li>
				...
				<a class='btn btn-warning form-control' href='?module=jadwalasesmen'>Kembali</a></div>";
													...
													$escaped_url = htmlspecialchars($url, ENT_QUOTES, 'UTF-8');
													$alamatip = $_SERVER['REMOTE_ADDR'];
													$sqlinputdigisign = "INSERT INTO `logdigisign`(`id_dokumen`, id_skema, id_asesi `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$sk[id]','$_SESSION[namauser]','$escaped_url','FR.AK.06. MENINJAU PROSES ASESMEN','$_SESSION[namalengkap]','$file','$alamatip')";
													$conn->query($sqlinputdigisign);
													echo "<div class='alert alert-success alert-dismissible'>
				<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
				<h4><i class='icon fa fa-check'></i> Laporan Meninjau Proses Asesmen berhasil disimpan</h4>
		...
		<section class='content-header'>
		  ...
		  <ol class='breadcrumb'>
			...
			<li class='active'>FR.IA.03</li>
				...
				<a class='btn btn-warning form-control' href='?module=pesertaasesmen&idj=$_GET[idj]'>Kembali</a></div>
				<script>window.location = '$base_url/media.php?module=form-fr-ia-03&ida=$_GET[ida]&idj=$_GET[idj]'</script>";
												} else {
													$image_parts = explode(";base64,", $_POST['signed']);
													$image_type_aux = explode("image/", $image_parts[0]);
													$image_type = $image_type_aux[1];
				...
				<thead><tr bgcolor='#D8D8D8'><th><b>2.</b></th><th><b>Mempersiapkan Rencana Asesmen </b></th></tr></thead>
						...
						<tr><th><b>L</b></th><th><b>TL</b></th><th><b>T</b></th><th width='10%'><img src='../images/mapa01-1.jpg' height='150'/></th><th width='10%'><img src='../images/mapa01-2.jpg' height='150'/></th><th width='10%'><img src='../images/mapa01-3.jpg' height='150'/></th><th width='10%'><img src='../images/mapa01-4.jpg' height='150'/></th><th width='10%'><img src='../images/mapa01-5.jpg' height='150'/></th><th width='10%'><img src='../images/mapa01-6.jpg' height='150'/></th></tr>";
								...
								<tr>
									...
									<td><input type='checkbox' name='L2_$noun$noel$nokuk' value='L'";
													if ($smapa1b['bukti_L2'] == "L") {
														echo " checked";
													} else {
														echo "";
													}
													echo "></td>
									<td><input type='checkbox' name='TL2_$noun$noel$nokuk' value='TL'";
													if ($smapa1b['bukti_TL2'] == "TL") {
														echo " checked";
													} else {
														echo "";
													}
													echo "></td>
									<td><input type='checkbox' name='T2_$noun$noel$nokuk' value='T'";
													if ($smapa1b['bukti_T2'] == "T") {
														echo " checked";
													} else {
														echo "";
													}
          ...
          <div class='box'>
			...
			<div style='overflow-x:auto;'>";
						...
						<tr><th>1</th><th>2</th><th>3</th><th>4</th><th>5</th>";
							...
							<td><input type='checkbox' name='muk$gtu[id]$gmuk[id]_1' id='options1$gtu[id]$gmuk[id]' value='1'";
												if ($gtmuk['kandidat1'] == "1") {
													echo " checked";
												}
												echo "></td>
							<td><input type='checkbox' name='muk$gtu[id]$gmuk[id]_2' id='options2$gtu[id]$gmuk[id]' value='1'";
												if ($gtmuk['kandidat2'] == "1") {
													echo " checked";
												}
												echo "></td>
							<td><input type='checkbox' name='muk$gtu[id]$gmuk[id]_3' id='options3$gtu[id]$gmuk[id]' value='1'";
												if ($gtmuk['kandidat3'] == "1") {
													echo " checked";
												}
												echo "></td>
							<td><input type='checkbox' name='muk$gtu[id]$gmuk[id]_4' id='options4$gtu[id]$gmuk[id]' value='1'";
												if ($gtmuk['kandidat4'] == "1") {
													echo " checked";
												}
												echo "></td>
							<td><input type='checkbox' name='muk$gtu[id]$gmuk[id]_5' id='options5$gtu[id]$gmuk[id]' value='1'";

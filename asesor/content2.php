						...
						echo "<div class='btn-group'>
							...
							<button type='button' class='btn btn-success dropdown-toggle' data-toggle='dropdown'>
							  ...
							  <li><a href='media.php?module=mapa1a&kand=1&idsk=$pm[id_skemakkni]' title='Input/Update MAPA 1 Kandidat 1'>Input/Update MAPA 1 Kandidat 1</a></li>
                  					  ...
                  					  <li><a href='form-mapa-01.php?idsk=$pm[id_skemakkni]&kand=1' title='Unduh MAPA 01-MERENCANAKAN AKTIVITAS DAN PROSES ASESMEN'>Unduh Form MAPA-01 Kandidat 1</a></li>
                  					  <li><a href='form-mapa-01.php?idsk=$pm[id_skemakkni]&kand=2' title='Unduh MAPA 01-MERENCANAKAN AKTIVITAS DAN PROSES ASESMEN'>Unduh Form MAPA-01 Kandidat 2</a></li>
                  					  <li><a href='form-mapa-01.php?idsk=$pm[id_skemakkni]&kand=3' title='Unduh MAPA 01-MERENCANAKAN AKTIVITAS DAN PROSES ASESMEN'>Unduh Form MAPA-01 Kandidat 3</a></li>
                  					  <li><a href='form-mapa-01.php?idsk=$pm[id_skemakkni]&kand=4' title='Unduh MAPA 01-MERENCANAKAN AKTIVITAS DAN PROSES ASESMEN'>Unduh Form MAPA-01 Kandidat 4</a></li>
                  					  <li><a href='form-mapa-01.php?idsk=$pm[id_skemakkni]&kand=5' title='Unduh MAPA 01-MERENCANAKAN AKTIVITAS DAN PROSES ASESMEN'>Unduh Form MAPA-01 Kandidat 5</a></li>
                  					  <li class='divider'></li>
                  					  ...
                  					  <li><a href='form-mapa-02.php?idsk=$pm[id_skemakkni]' title='Unduh MAPA 02-PETA INSTRUMEN ASESMEN HASIL PENDEKATAN ASESMEN DAN PERENCANAAN ASESMEN'>Unduh Form MAPA-02</a></li>
							  <li><a href='media.php?module=form-fr-ak-05&idj=$pm[id]' title='Input/Update AK 05-LAPORAN ASESMEN'>Input/Update Form AK-05</a></li>
							  <li><a href='form-ak-05.php?idj=$pm[id]' title='Unduh AK 05-LAPORAN ASESMEN'>Unduh Form AK-05</a></li>
							  ...
							  <li><a href='form-ak-06.php?idj=$pm[id]' title='Unduh AK 06-MENINJAU PROSES ASESMEN'>Unduh Form AK-06</a></li>
                  					</ul>
                				</div>";
						}
						/*if ($jumps==0){
			...
			<div style='overflow-x:auto;'>
				<table id='example1' class='table table-bordered table-striped'>
					...
					while ($pm=$jadwaltuk->fetch_assoc()){
							...
							<button type='button' class='btn btn-success dropdown-toggle' data-toggle='dropdown'>
							  <span class='caret'></span>
                  					...
                  					<ul class='dropdown-menu' role='menu'>
                  					  ...
                  					  <li><a href='form-fr-ia-11.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='CEKLIS MENINJAU INSTRUMEN ASESSMEN'>Unduh Formulir FR-IA-11</a></li>
                  					</ul>
                				</div>";
						...
						if ($jumapl02>0){echo "<br><font color='red'>Telah mengisi Asesmen Mandiri (APL-02)</font>";}
						if ($jumasesmen>0){echo "<br><font color='green'><b>Keputusan Asesmen telah dibuat dan dinyatakan</b></font> : ";
  ...
  if (!empty($_SESSION['namauser'])){
	...
	{	
		...
		if(empty($_POST['signed'])){
			...
			$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FORM CEKLIST VERIFIKASI TUK','$_SESSION[namalengkap]','$file','$alamatip')";
				...
				<table id='example' class='table table-bordered table-striped'>
					...
					while ($pm=$lsp->fetch_assoc()){
						...
						echo "<td><input type='hidden' name='asesor_$pm[id]' value='$rowAgen[id]'>
							...
							Jumlah Total:<br><input type='text' class='form-control' name='jumlah_$pm[id]'"; if ($jumjw>0){echo " value='$vjw[jumlah]'";}else{echo "";} echo " required><br>
							<b>Kondisi :</b><br>Jumlah Baik :<br><input type='text' class='form-control' name='baik_$pm[id]'"; if ($jumjw>0){echo " value='$vjw[baik]'";}else{echo "";} echo " required><br>
							Jumlah Rusak :<br><input type='text' class='form-control' name='rusak_$pm[id]'"; if ($jumjw>0){echo " value='$vjw[rusak]'";}else{echo "";} echo " required><br>
							Keterangan : <br><textarea name='keterangan_$pm[id]' class='form-control' placeholder='keterangan'>"; if ($jumjw>0){echo "$vjw[keterangan]";}else{echo "";} echo "</textarea></td></tr>";
						$no++;
					}
				echo "</tbody></table>
				</div>";
			...
			<div style='overflow-x:auto;'>
				<table id='example1' class='table table-bordered table-striped'>
					...
					while ($pm=$jadwaltuk->fetch_assoc()){
                  					...
                  					<ul class='dropdown-menu' role='menu'>
										...
										if ($jnsapl02['apl02']=='elemen'){
											if ($jumcekapl02==0){
												...
												<li><a href='form-apl-02-el.php?ida=$pm[id_asesi]&idj=$_GET[idj]'>Unduh Formulir APL-02</a></li>";
											}else{
											...
											if ($jumcekapl02==0){
												...
												<li><a href='form-apl-02.php?ida=$pm[id_asesi]&idj=$_GET[idj]'>Unduh Formulir APL-02</a></li>";
											}else{
												echo"<li><a href='?module=form-apl-02&ida=$pm[id_asesi]&idj=$_GET[idj]'>Update APL-02 Terverifikasi $jumcekapl02 item</a></li>
												<li><a href='form-apl-02.php?ida=$pm[id_asesi]&idj=$_GET[idj]'>Unduh Formulir APL-02</a></li>";
											}
										}
									  echo"<li><a href='form-mapa-01.php?idsk=$pm[id_skemakkni]&kand=1' title='FORMULIR MERENCANAKAN AKTIVITAS DAN PROSES ASESMEN untuk Kandidat Tipe 1'>Unduh FORM-MAPA-01 Kandidat 1</a></li>
                  					  <li><a href='form-mapa-01.php?idsk=$pm[id_skemakkni]&kand=2' title='FORMULIR MERENCANAKAN AKTIVITAS DAN PROSES ASESMEN untuk Kandidat Tipe 2'>Unduh FORM-MAPA-01 Kandidat 2</a></li>
                  					  <li><a href='form-mapa-01.php?idsk=$pm[id_skemakkni]&kand=3' title='FORMULIR MERENCANAKAN AKTIVITAS DAN PROSES ASESMEN untuk Kandidat Tipe 3'>Unduh FORM-MAPA-01 Kandidat 3</a></li>
                  					  <li><a href='form-mapa-01.php?idsk=$pm[id_skemakkni]&kand=4' title='FORMULIR MERENCANAKAN AKTIVITAS DAN PROSES ASESMEN untuk Kandidat Tipe 4'>Unduh FORM-MAPA-01 Kandidat 4</a></li>
                  					  <li><a href='form-mapa-01.php?idsk=$pm[id_skemakkni]&kand=5' title='FORMULIR MERENCANAKAN AKTIVITAS DAN PROSES ASESMEN untuk Kandidat Tipe 5'>Unduh FORM-MAPA-01 Kandidat 5</a></li>
                  					  <li><a href='form-mapa-02.php?idsk=$pm[id_skemakkni]' title='FORMULIR PETA MUK DARI HASIL PENDEKATAN ASESMEN DAN PERENCANAAN ASESMEN'>Unduh FORM-MAPA-02</a></li>
                  					  ...
                  					  <li><a href='form-fr-ak-01.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='FORMULIR PERSETUJUAN ASESMEN DAN KERAHASIAAN'>Unduh Formulir FR-AK-01</a></li>
                   					  <li><a href='?module=form-fr-ak-02&ida=$pm[id_asesi]&idj=$_GET[idj]' title='INPUT FORMULIR REKAMAN ASESMEN KOMPETENSI'>Input Formulir FR-AK-02</a></li>
                 					  <li><a href='form-fr-ak-02.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='FORMULIR REKAMAN ASESMEN KOMPETENSI'>Unduh Formulir FR-AK-02</a></li>
                  					  <li><a href='form-fr-ak-03.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='FORMULIR UMPAN BALIK DAN CATATAN ASESMEN'>Unduh Formulir FR-AK-03</a></li>
                  					  <li><a href='form-fr-ak-04.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='FORMULIR BANDING ASESMEN'>Unduh Formulir FR-AK-04</a></li>
                  					  ...
                  					  <li><a href='form-fr-ia-01.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='FORMULIR CEKLIS OBSERVASI AKTIVITAS DI TEMPAT KERJA ATAU TEMPAT KERJA SIMULASI'>Unduh Formulir FR-IA-01</a></li>
                  					  <li><a href='form-fr-ia-02.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='TUGAS PRAKTIK DEMONSTRASI'>Unduh Formulir FR-IA-02</a></li>
                  					  <li><a href='?module=form-fr-ia-03&ida=$pm[id_asesi]&idj=$_GET[idj]' title='INPUT FORMULIR PERTANYAAN PENDUKUNG OBSERVASI'>Input Formulir FR-IA-03</a></li>
                  					  <li><a href='form-fr-ia-03.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='PERTANYAAN UNTUK MENDUKUNG OBSERVASI'>Unduh Formulir FR-IA-03</a></li>
                  					  <li><a href='form-fr-ia-05.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='PERTANYAAN TERTULIS PILIHAN GANDA'>Unduh Formulir FR-IA-05</a></li>
                  					  <li><a href='form-fr-ia-05b.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='JAWABAN PERTANYAAN TERTULIS PILIHAN GANDA'>Unduh Jawaban Asesi FR-IA-05</a></li>
                  					  <li><a href='form-fr-ia-06.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='PERTANYAAN TERTULIS ESAI'>Unduh Formulir FR-IA-06</a></li>
                  					  <li><a href='form-fr-ia-06a.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='LEMBAR KUNCI JAWABAN PERTANYAAN TERTULIS ESAI'>Unduh Formulir FR-IA-06.A</a></li>
                  					  ...
                  					  <li><a href='form-fr-ia-06b.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='LEMBAR JAWABAN PERTANYAAN TERTULIS ESAI'>Unduh Formulir FR-IA-06.B</a></li>
                  					  ...
                  					  <li><a href='form-fr-ia-07.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='PERTANYAAN LISAN'>Unduh Formulir FR-IA-07</a></li>
                  					  ...
                  					  <li><a href='form-fr-ia-08.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='CEKLIS VERIFIKASI PORTOFOLIO'>Unduh Formulir FR-IA-08</a></li>
                  					  <li><a href='?module=form-fr-ia-09&ida=$pm[id_asesi]&idj=$_GET[idj]' title='PERTANYAAN WAWANCARA'>Input Formulir FR-IA-09</a></li>
                  					  <li><a href='form-fr-ia-10.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='KLARIFIKASI BUKTI PIHAK KETIGA'>Unduh Formulir FR-IA-10</a></li>
                  					  <li><a href='?module=peninjauasesmen' title='CEKLIS MENINJAU INSTRUMEN ASESSMEN'>Input Formulir FR-IA-11</a></li>
                  					  <li><a href='form-fr-ia-11.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='CEKLIS MENINJAU INSTRUMEN ASESSMEN'>Unduh Formulir FR-IA-11</a></li>
                  					  <li><a href='form-fr-va.php?ida=$pm[id_asesi]&idj=$_GET[idj]' title='MEMBERIKAN KONTRIBUSI DALAM VALIDASI ASESMEN'>Unduh Formulir FR-VA</a></li>
                  					</ul>
                				</div>";
						...
						if ($statussoalia05>0){
							$nilaigradex=($skorx['TotSkor']/$statussoalia05)*100;
							$nilaigrade=round($nilaigradex,2);
...
echo "<!-- Content Header (Page header) -->
	...
	{				
		...
		$folderPath = "../foto_tandatangan/";
			...
			$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
			$alamatip=$_SERVER['REMOTE_ADDR'];
			$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.APL.02. ASESMEN MANDIRI','$_SESSION[namalengkap]','$file','$alamatip')";
    			$conn->query($sqlinputdigisign);
			echo "<div class='alert alert-success alert-dismissible'>
			<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
			<h4><i class='icon fa fa-check'></i> Penilaian Asesor berhasil disimpan</h4>
    ...
    <section class='content'>
      <div class='row'>
											...
											case "1":
												...
												<div class='col-md-4'>
													<div class='form-group'>
														...
														echo "<textarea name='bukti$el[id]' id='bukti$el[id]' class='form-control' placeholder='isikan bukti-bukti kompetensi'>$jjw0[keterangan_bukti]</textarea>";
													echo "</div><!-- /.form-group-->
												</div><!-- /.col-->";
											break;
											case "0":
		...
		echo "<div class='col-md-12'>
			<h3>Rekomendasi :</h3>
				<input type='radio' required='required' name='status_apl02' id='rekomendasiapl021' value='A'"; if ($getassm['status_apl02']=="A"){echo " checked";}else{echo "";} echo ">
				Asesmen dapat dilanjutkan<br>
				<input type='radio' required='required' name='status_apl02' id='rekomendasiapl022' value='R'"; if ($getassm['status_apl02']=="R"){echo " checked";}else{echo "";} echo ">
		...
		<div class='col-md-4 col-sm-12 col-xs-12'>
				<a href='form-apl-02-el.php?ida=$_GET[ida]&idj=$_GET[idj]' class='btn btn-primary form-control'>Unduh Form Jawaban</a>
		</div>
		<div class='col-md-4 col-sm-12 col-xs-12'>
...
echo "<!-- Content Header (Page header) -->
	...
	{				
		...
		$folderPath = "../foto_tandatangan/";
			...
			$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
			$alamatip=$_SERVER['REMOTE_ADDR'];
			$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR-APL-01. FORMULIR PERMOHONAN SERTIFIKASI KOMPETENSI','$rowAgen[nama]','$file','$alamatip')";
    			$conn->query($sqlinputdigisign);
			echo "<div class='alert alert-success alert-dismissible'>
			<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
			<h4><i class='icon fa fa-check'></i> Penilaian Asesor berhasil disimpan</h4>
    ...
    <section class='content'>
      <div class='row'>
		...
		<div class='col-md-4 col-sm-12 col-xs-12'>
				<a href='form-apl-02.php?ida=$_GET[ida]&idj=$_GET[idj]' class='btn btn-primary form-control'>Unduh Form Jawaban</a>
		</div>
		<div class='col-md-4 col-sm-12 col-xs-12'>
				<button type='submit' class='btn btn-success form-control' name='simpan'>Simpan Jawaban</button>
		</div>
    ...
    <section class='content'>
      <div class='row'>
									...
									if ($numjjw0==0){
										...
										if ($jjw0['jawaban']==1){
											...
											<div class='col-md-4'>
												...
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkbox1$kr[id]' id='options1$kr[id]' value='V'";if ($jjw0['verifikasi_asesor1']=="V"){echo "checked";} echo">";
												echo " Valid &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkbox2$kr[id]' id='options2$kr[id]' value='A'";if ($jjw0['verifikasi_asesor2']=="A"){echo "checked";} echo">";
												echo " Autentik &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkbox3$kr[id]' id='options3$kr[id]' value='T'";if ($jjw0['verifikasi_asesor3']=="T"){echo "checked";} echo">";
												echo " Terkini &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkbox4$kr[id]' id='options4$kr[id]' value='M'";if ($jjw0['verifikasi_asesor4']=="M"){echo "checked";} echo">";
												echo " Memadai &nbsp;&nbsp;&nbsp;
												</label></div>
											</div></div>
											<div class='col-md-12'><div class='col-md-6'>
												...
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxa$kr[id]' id='options1b$kr[id]' value='L'";if ($jjw0['bukti1']=="L"){echo "checked";} echo">";
												echo " Bukti Langsung &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxb$kr[id]' id='options2b$kr[id]' value='TL'";if ($jjw0['bukti2']=="TL"){echo "checked";} echo">";
												echo " Bukti Tidak Langsung &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxc$kr[id]' id='options3b$kr[id]' value='T'";if ($jjw0['bukti3']=="T"){echo "checked";} echo">";
												echo " Bukti Tambahan
												</label>
												</div></div>
											</div>
											<div class='col-md-6'>
												...
												<label>";
												echo "<input type='radio' class='minimal' name='optionsRadiosc$kr[id]' id='options1c$kr[id]' value='K'";if ($jjw0['keputusan']=="K"){echo "checked";} echo">";
												echo " Kompeten &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='optionsRadiosc$kr[id]' id='options2c$kr[id]' value='BK'";if ($jjw0['keputusan']=="BK"){echo "checked";} echo">";
												echo " Belum Kompeten &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='optionsRadiosc$kr[id]' id='options3c$kr[id]' value='PL'";if ($jjw0['keputusan']=="PL"){echo "checked";} echo">";
												echo " Asesmen Lanjut
												</label>
												</div></div>
											</div></div>";
		...
		<div class='col-md-12'><label class='text-yellow'>
					...
					<label>";
						echo "<input type='radio' class='minimal' name='keputusanfinal' id='keputusanfinal1' value='R'";if ($getk['keputusan_asesor']=="R"){echo "checked";} echo">";
						echo " Direkomendasikan &nbsp;&nbsp;&nbsp;
					</label>
					<label>";
						echo "<input type='radio' class='minimal' name='keputusanfinal' id='keputusanfinal2' value='NR'";if ($getk['keputusan_asesor']=="NR"){echo "checked";} echo">";
	...
	if ($ukom>0){
								...
								while($kr=$getkriteria->fetch_assoc()){
									...
									$filebukti=$conn->query($getfilebukti);
											...
											switch ($jjw0['pencapaian']){
												...
												<label>";
												echo "<input type='radio' class='minimal' name='pencapaian$kr[id]' id='options1c$kr[id]' value='Y'";if ($jjw0['pencapaian']=="Y"){echo "checked";} echo">";
												echo " Ya &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='pencapaian$kr[id]' id='options2c1$kr[id]' value='N'";if ($jjw0['pencapaian']=="N"){echo "checked";} echo">";
												echo " Tidak &nbsp;&nbsp;&nbsp;
												</label>
												</div>
											</div></div>";			
			...
			$jjw1=$cekjawaban1->fetch_assoc();
										echo "<div class='col-md-12'>
												...
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxa1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options1b$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='L'";if ($jjw1['bukti1-1']=="L"){echo "checked";} echo">";
												echo " Bukti Langsung &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxb1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options2b$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='TL'";if ($jjw1['bukti1-2']=="TL"){echo "checked";} echo">";
												echo " Bukti Tidak Langsung &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxc1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options3b$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='T'";if ($jjw1['bukti1-3']=="T"){echo "checked";} echo">";
												echo " Bukti Tambahan
												</label>
												</div></div>
											</div>
											<div class='col-md-12'>
												...
												<label>";
												echo "<input type='radio' class='minimal' name='pencapaian1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options1c1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='Y'";if ($jjw1['pencapaian1']=="Y"){echo "checked";} echo">";
												echo " Ya &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='pencapaian1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options2c1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='N'";if ($jjw1['pencapaian1']=="N"){echo "checked";} echo">";
												echo " Tidak &nbsp;&nbsp;&nbsp;
												</label>
												</div></div>
											</div>			
											<div class='col-md-12'>
												...
												<label>";
												echo "<input type='radio' class='minimal' name='keputusan1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options1c1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='K'";if ($jjw1['keputusan1']=="K"){echo "checked";} echo">";
												echo " Kompeten &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='keputusan1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options2c1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='BK'";if ($jjw1['keputusan1']=="BK"){echo "checked";} echo">";
												echo " Belum Kompeten &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='keputusan1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options3c1$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='PL'";if ($jjw1['keputusan1']=="PL"){echo "checked";} echo">";
												echo " Asesmen Lanjut
												</label>
												</div></div>
											</div>
											<div class='col-md-12'>
												...
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxa2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options1b$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='L'";if ($jjw1['bukti2-1']=="L"){echo "checked";} echo">";
												echo " Bukti Langsung &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxb2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options2b$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='TL'";if ($jjw1['bukti2-2']=="TL"){echo "checked";} echo">";
												echo " Bukti Tidak Langsung &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxc2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options3b$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='T'";if ($jjw1['bukti2-3']=="T"){echo "checked";} echo">";
												echo " Bukti Tambahan
												</label>
												</div></div>
											</div>
											<div class='col-md-12'>
												...
												<label>";
												echo "<input type='radio' class='minimal' name='pencapaian2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options1c2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='Y'";if ($jjw1['pencapaian2']=="Y"){echo "checked";} echo">";
												echo " Ya &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='pencapaian2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options2c2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='N'";if ($jjw1['pencapaian2']=="N"){echo "checked";} echo">";
												echo " Tidak &nbsp;&nbsp;&nbsp;
												</label>
												</div></div>
											</div>			
											<div class='col-md-12'>
												...
												<label>";
												echo "<input type='radio' class='minimal' name='keputusan2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options1c2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='K'";if ($jjw1['keputusan2']=="K"){echo "checked";} echo">";
												echo " Kompeten &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='keputusan2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options2c2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='BK'";if ($jjw1['keputusan2']=="BK"){echo "checked";} echo">";
												echo " Belum Kompeten &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='keputusan2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options3c2$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='PL'";if ($jjw1['keputusan2']=="PL"){echo "checked";} echo">";
												echo " Asesmen Lanjut
												</label>
												</div></div>
											</div>
											<div class='col-md-12'>
												...
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxa3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options1b$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='L'";if ($jjw1['bukti3-1']=="L"){echo "checked";} echo">";
												echo " Bukti Langsung &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxb3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options2b$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='TL'";if ($jjw1['bukti3-2']=="TL"){echo "checked";} echo">";
												echo " Bukti Tidak Langsung &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='checkbox' class='flat-red' name='checkboxc3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options3b$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='T'";if ($jjw1['bukti3-3']=="T"){echo "checked";} echo">";
												echo " Bukti Tambahan
												</label>
												</div></div>
											</div>
											<div class='col-md-12'>
												...
												<label>";
												echo "<input type='radio' class='minimal' name='pencapaian3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options1c3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='Y'";if ($jjw1['pencapaian3']=="Y"){echo "checked";} echo">";
												echo " Ya &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='pencapaian3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options2c3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='N'";if ($jjw1['pencapaian3']=="N"){echo "checked";} echo">";
												echo " Tidak &nbsp;&nbsp;&nbsp;
												</label>
												</div></div>
											</div>			
											<div class='col-md-12'>
												...
												<label>";
												echo "<input type='radio' class='minimal' name='keputusan3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options1c3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='K'";if ($jjw1['keputusan3']=="K"){echo "checked";} echo">";
												echo " Kompeten &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='keputusan3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options2c3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='BK'";if ($jjw1['keputusan3']=="BK"){echo "checked";} echo">";
												echo " Belum Kompeten &nbsp;&nbsp;&nbsp;
												</label>
												<label>";
												echo "<input type='radio' class='minimal' name='keputusan3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' id='options3c3$jd[id]-$jd[id_skemakkni]-$unk[id]-$_GET[ida]' value='PL'";if ($jjw1['keputusan3']=="PL"){echo "checked";} echo">";
												echo " Asesmen Lanjut
												</label>
												</div></div>
											</div>";
            ...
            <div class='box-body'>
              <!-- form start -->
            	<div class='box-body'>
					...
					<table id='example9' class='table table-bordered table-striped'>
						<tr><td rowspan='4' width='25%'>Bukti yang akan dikumpulkan</td><td>";
							echo "<input type='checkbox' class='flat-red' name='checkboxVP' id='optionsVP' value='1'";if ($jjw['VP']=="1"){echo "checked";}else{echo "";} echo"> TL : Verifikasi Portfolio";
							echo "</td><td>";
							echo "<input type='checkbox' class='flat-red' name='checkboxCL' id='optionsCL' value='1'";if ($jjw['CL']=="1"){echo "checked";}else{echo "";} echo"> L : Observasi Langsung";
							echo "</td>
						</tr>
						<tr><td colspan='2'>";
							echo "<input type='checkbox' class='flat-red' name='checkboxDPT' id='optionsDPT' value='1'";if ($jjw['DPT']=="1"){echo "checked";}else{echo "";} echo"> T : Hasil Tes Tulis";
							echo "</td>
						</tr>
						<tr><td colspan='2'>";
							echo "<input type='checkbox' class='flat-red' name='checkboxDPL' id='optionsDPL' value='1'";if ($jjw['DPL']=="1"){echo "checked";}else{echo "";} echo"> L : Hasil Tes Lisan";
							echo "</td>
						</tr>
						<tr><td colspan='2'>";
							echo "<input type='checkbox' class='flat-red' name='checkboxPW' id='optionsPW' value='1'";if ($jjw['PW']=="1"){echo "checked";}else{echo "";} echo"> L : Hasil Wawancara";
							echo "</td>
						</tr>
					</table>
					<table id='example9' class='table table-bordered table-striped'>
					...
					<p><b>Asesor :</b><br />
					<input type='checkbox' class='flat-red' name='persetujuan' id='optionsPersetujuan' value='Y'";if ($jjw['persetujuan']=="Y"){echo "checked";}else{echo "";} echo" required> Menyatakan tidak akan membuka hasil pekerjaan yang saya peroleh karena penugasan saya sebagai Asesor dalam pekerjaan Asesmen kepada siapapun atau organisasi apapun selain kepada pihak yang berwenang sehubungan dengan kewajiban saya sebagai Asesor yang ditugaskan oleh LSP.
					</p>";
				// cek tandatangan digital
				$url = "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
				$iddokumen=md5($url);
				...
				echo "<div class='box-footer bg-black'>
					...
					<div class='col-md-4 col-sm-12 col-xs-12'>
							<a href='form-fr-ak-01.php?ida=$_GET[ida]&idj=$_GET[idj]' class='btn btn-primary form-control'>Unduh Formulir</a>
					</div>
					<div class='col-md-4 col-sm-12 col-xs-12'>
							<button type='submit' class='btn btn-success form-control' name='simpan'>Simpan Jawaban</button>
					</div>
...
echo "<!-- Content Header (Page header) -->
	...
	{				
		...
		if(empty($_POST['signed'])){
			...
			$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
			$alamatip=$_SERVER['REMOTE_ADDR'];
			$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.AK.02. FORMULIR REKAMAN ASESMEN KOMPETENSI','$_SESSION[namalengkap]','$file','$alamatip')";
			$conn->query($sqlinputdigisign);
			//unit kompetensi
			$sqlgetunitkompetensi0="SELECT * FROM `unit_kompetensi` WHERE `id_skemakkni`='$sk[id]'";
			$getunitkompetensi0=$conn->query($sqlgetunitkompetensi0);
            ...
            <div class='box-body'>
              <!-- form start -->
            	<div class='box-body'>
					...
					<table id='example9' class='table table-bordered table-striped'>
						...
						while ($unk2=$getunitkompetensi2->fetch_assoc()){
							...
							echo "<td><input type='checkbox' class='flat-red' name='checkboxCL".$unk2['id']."' id='optionsCL".$unk2['id']."' value='1'";if ($jjw['CL']=="1"){echo "checked";}else{echo "";} echo"></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxVP".$unk2['id']."' id='optionsVP".$unk2['id']."' value='1'";if ($jjw['VP']=="1"){echo "checked";}else{echo "";} echo"></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxPW".$unk2['id']."' id='optionsPW".$unk2['id']."' value='1'";if ($jjw['PW']=="1"){echo "checked";}else{echo "";} echo"></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxDPL".$unk2['id']."' id='optionsDPL".$unk2['id']."' value='1'";if ($jjw['DPL']=="1"){echo "checked";}else{echo "";} echo"></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxDPT".$unk2['id']."' id='optionsDPT".$unk2['id']."' value='1'";if ($jjw['DPT']=="1"){echo "checked";}else{echo "";} echo"></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxCUP".$unk2['id']."' id='optionsCUP".$unk2['id']."' value='1'";if ($jjw['CUP']=="1"){echo "checked";}else{echo "";} echo"></td>";
							echo "<td><input type='checkbox' class='flat-red' name='checkboxLainnya".$unk2['id']."' id='optionsLainnya".$unk2['id']."' value='1'";if ($jjw['Lainnya']=="1"){echo "checked";}else{echo "";} echo"></td>";
							echo "</tr>";
						}
					echo "</table>
					<table id='example9' class='table table-bordered table-striped'>
				...
				echo "<div class='box-footer bg-black'>
					...
					<div class='col-md-4 col-sm-12 col-xs-12'>
							<a href='form-fr-ak-02.php?ida=$_GET[ida]&idj=$_GET[idj]' class='btn btn-primary form-control'>Unduh Formulir</a>
					</div>
					<div class='col-md-4 col-sm-12 col-xs-12'>
							<button type='submit' class='btn btn-success form-control' name='simpan'>Simpan Jawaban</button>
					</div>
	...
	{				
		...
		if ($cekak01>0){
			...
			if(empty($_POST['signed'])){
				...
				$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
				$alamatip=$_SERVER['REMOTE_ADDR'];
				$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.AK.05. LAPORAN ASESMEN','$_SESSION[namalengkap]','$file','$alamatip')";
				$conn->query($sqlinputdigisign);
				echo "<div class='alert alert-success alert-dismissible'>
				<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
				<h4><i class='icon fa fa-check'></i> Laporan Asesmen berhasil disimpan</h4>
            ...
            <div class='box-body'>
              <!-- form start -->
            	<div class='box-body'>
					...
					<textarea class='form-control' name='aspek'>";if (!empty($jjw['aspek'])){echo $jjw['aspek'];}else{echo "";} echo "</textarea>
					</div>
					<div class='col-md-12'>
					<label><b>Pencatatan Penolakan Hasil Asesmen :</b></label><br />
					<textarea class='form-control' name='catatan_penolakan'>";if (!empty($jjw['catatan_penolakan'])){echo $jjw['catatan_penolakan'];}else{echo "";} echo "</textarea>
					</div>
					<div class='col-md-12'>
					<label><b>Saran Perbaikan (Asesor/Personil Terkait) :</b></label><br />
					<textarea class='form-control' name='saran_perbaikan'>";if (!empty($jjw['saran_perbaikan'])){echo $jjw['saran_perbaikan'];}else{echo "";} echo "</textarea>
					</div>
					<div class='col-md-12'>
					<label><b>Catatan: :</b></label><br />
					<textarea class='form-control' name='catatan'>";if (!empty($jjw['catatan'])){echo $jjw['catatan'];}else{echo "";} echo "</textarea>
					</div>";
				// cek tandatangan digital
				$url = "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
				$iddokumen=md5($url);
	...
	{				
		...
		if ($cekak01>0){
			...
			if(empty($_POST['signed'])){
				...
				$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
				$alamatip=$_SERVER['REMOTE_ADDR'];
				$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.AK.06. MENINJAU PROSES ASESMEN','$_SESSION[namalengkap]','$file','$alamatip')";
				$conn->query($sqlinputdigisign);
				echo "<div class='alert alert-success alert-dismissible'>
				<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
				<h4><i class='icon fa fa-check'></i> Laporan Meninjau Proses Asesmen berhasil disimpan</h4>
            ...
            <div class='box-body'>
              <!-- form start -->
            	<div class='box-body'>
					...
					<table id='example9' class='table table-bordered table-striped'>
						...
						<tbody>
							...
							<tr>
								...
								<td><input type='checkbox' class='flat-red' name='rencana_v' id='rencana_v' value='1'";if ($jjw['rencana_v']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='rencana_r' id='rencana_r' value='1'";if ($jjw['rencana_r']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='rencana_f' id='rencana_f' value='1'";if ($jjw['rencana_f']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='rencana_a' id='rencana_a' value='1'";if ($jjw['rencana_a']=="1"){echo " checked";} echo "></td>
							</tr>
							<tr>
								<td>Persiapan asesmen</td>
								<td><input type='checkbox' class='flat-red' name='persiapan_v' id='persiapan_v' value='1'";if ($jjw['persiapan_v']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='persiapan_r' id='persiapan_r' value='1'";if ($jjw['persiapan_r']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='persiapan_f' id='persiapan_f' value='1'";if ($jjw['persiapan_f']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='persiapan_a' id='persiapan_a' value='1'";if ($jjw['persiapan_a']=="1"){echo " checked";} echo "></td>
							</tr>
							<tr>
								<td>Implementasi asesmen</td>
								<td><input type='checkbox' class='flat-red' name='implementasi_v' id='implementasi_v' value='1'";if ($jjw['implementasi_v']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='implementasi_r' id='implementasi_r' value='1'";if ($jjw['implementasi_r']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='implementasi_f' id='implementasi_f' value='1'";if ($jjw['implementasi_f']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='implementasi_a' id='implementasi_a' value='1'";if ($jjw['implementasi_a']=="1"){echo " checked";} echo "></td>
							</tr>
							<tr>
								<td>Keputusan asesmen</td>
								<td><input type='checkbox' class='flat-red' name='keputusan_v' id='keputusan_v' value='1'";if ($jjw['keputusan_v']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='keputusan_r' id='keputusan_r' value='1'";if ($jjw['keputusan_r']=="1"){echo " checked";} echo "></td>
								<td></td>
								<td><input type='checkbox' class='flat-red' name='keputusan_a' id='keputusan_a' value='1'";if ($jjw['keputusan_a']=="1"){echo " checked";} echo "></td>
							</tr>
							<tr>
								<td>Umpan balik asesmen</td>
								<td><input type='checkbox' class='flat-red' name='umpanbalik_v' id='umpanbalik_v' value='1'";if ($jjw['umpanbalik_v']=="1"){echo " checked";} echo "></td>
								<td><input type='checkbox' class='flat-red' name='umpanbalik_r' id='umpanbalik_r' value='1'";if ($jjw['umpanbalik_r']=="1"){echo " checked";} echo "></td>
								<td></td>
								<td><input type='checkbox' class='flat-red' name='umpanbalik_a' id='umpanbalik_a' value='1'";if ($jjw['umpanbalik_a']=="1"){echo " checked";} echo "></td>
							</tr>
						</tbody>
					</table>
					<div class='col-md-12'>
					<label><b>Rekomendasi untuk peningkatan</b></label><br />
					<textarea class='form-control' name='rekomendasi'>";if (!empty($jjw['rekomendasi'])){echo $jjw['rekomendasi'];}else{echo "";} echo "</textarea>
					</div>
					<table id='example9' class='table table-bordered table-striped'>
						<thead>
						...
						<tbody>
							<tr>
								...
								<td>
									<textarea class='form-control' name='ts'>";if (!empty($jjw['ts'])){echo $jjw['ts'];}else{echo "";} echo "</textarea>
								</td>
								<td>
									<textarea class='form-control' name='tms'>";if (!empty($jjw['tms'])){echo $jjw['tms'];}else{echo "";} echo "</textarea>
								</td>
								<td>
									<textarea class='form-control' name='cms'>";if (!empty($jjw['cms'])){echo $jjw['cms'];}else{echo "";} echo "</textarea>
								</td>
								<td>
									<textarea class='form-control' name='jres'>";if (!empty($jjw['jres'])){echo $jjw['jres'];}else{echo "";} echo "</textarea>
								</td>
								<td>
									<textarea class='form-control' name='trs'>";if (!empty($jjw['trs'])){echo $jjw['trs'];}else{echo "";} echo "</textarea>
								</td>
							</tr>
						</tbody>
					</table>
					<div class='col-md-12'>
					<label><b>Rekomendasi untuk peningkatan</b></label><br />
					<input type='checkbox' class='flat-red' name='rekomdimensi1' id='rekomdimensi1' value='1'";if ($jjw['rekomdimensi1']=="1"){echo " checked";} echo ">&nbsp;Seluruh dimensi kompetensi sudah tergali pada perangkat asesmen unit kompetensi yang diases<br/>
					<input type='checkbox' class='flat-red' name='rekomdimensi2' id='rekomdimensi2' value='1'";if ($jjw['rekomdimensi2']=="1"){echo " checked";} echo ">&nbsp;Dimensi kompetensi : <input type='checkbox' class='flat-red' name='rekomdimensi2a' id='rekomdimensi2a' value='1'";if ($jjw['rekomdimensi2a']=="1"){echo " checked";} echo "> TMS / <input type='checkbox' class='flat-red' name='rekomdimensi2b' id='rekomdimensi2b' value='1'";if ($jjw['rekomdimensi2b']=="1"){echo " checked";} echo "> CMS / <input type='checkbox' class='flat-red' name='rekomdimensi2c' id='rekomdimensi2c' value='1'";if ($jjw['rekomdimensi2c']=="1"){echo " checked";} echo "> JRES belum tergali pada perangkat asesmen unit kompetensi yang diases, sehingga harus diperbaiki untuk pelaksanaan selanjutnya.<br/>
					</div>
					<div class='col-md-12'>
					<label><b>Aspek Negatif dan Positif dalam Asesemen :</b></label><br />
					<textarea class='form-control' name='aspek'>";if (!empty($jjw['aspek'])){echo $jjw['aspek'];}else{echo "";} echo "</textarea>
...
echo "<!-- Content Header (Page header) -->
	...
	{				
		...
		if(empty($_POST['signed'])){
			...
			$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
			$alamatip=$_SERVER['REMOTE_ADDR'];
			$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.IA.01. CEKLIS OBSERVASI AKTIVITAS DI TEMPAT KERJA ATAU TEMPAT KERJA SIMULASI','$_SESSION[namalengkap]','$file','$alamatip')";
			$conn->query($sqlinputdigisign);
			echo "<div class='alert alert-success alert-dismissible'>
			<button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
			<h4><i class='icon fa fa-check'></i> Penilaian Asesor berhasil disimpan</h4>
          ...
          <div class='box'>
            <div class='box-body'>
              <!-- form start -->
														...
														<span class='text-red'><b>Belum menjawab</b></span>
															...
															if ($jjw0['jawaban']==1){
																...
																<div class='col-md-4'>
																	...
																	echo "<br><textarea name='bukti$el[id]' id='bukti$el[id]' class='form-control' placeholder='isikan Benchmark (SOP / spesifikasi produk industri)'>$jjw0[benchmark]</textarea>";
																	echo "</div>
																</div>
																<div class='col-md-3'>
																	<div class='form-group'><label>
																	...
																	<label>";
																	echo "<input type='checkbox' class='flat-red' name='checkbox1$el[id]' id='options1$el[id]' value='V'";if ($jjw0['verifikasi_asesor1']=="V"){echo "checked";} echo">";
																	echo " Valid &nbsp;&nbsp;&nbsp;
																	</label>
																	<label>";
																	echo "<input type='checkbox' class='flat-red' name='checkbox2$el[id]' id='options2$el[id]' value='A'";if ($jjw0['verifikasi_asesor2']=="A"){echo "checked";} echo">";
																	echo " Autentik &nbsp;&nbsp;&nbsp;
																	</label>
																	<label>";
																	echo "<input type='checkbox' class='flat-red' name='checkbox3$el[id]' id='options3$el[id]' value='T'";if ($jjw0['verifikasi_asesor3']=="T"){echo "checked";} echo">";
																	echo " Terkini &nbsp;&nbsp;&nbsp;
																	</label>
																	<label>";
																	echo "<input type='checkbox' class='flat-red' name='checkbox4$el[id]' id='options4$el[id]' value='M'";if ($jjw0['verifikasi_asesor4']=="M"){echo "checked";} echo">";
																	echo " Memadai &nbsp;&nbsp;&nbsp;
																	</label></div>
																</div>";
																switch ($jjw0['pencapaian']){
																	...
																	<label>";
																	echo "<input type='radio' class='minimal' name='pencapaian$el[id]' id='options1c$el[id]' value='K'";if ($jjw0['pencapaian']=="K"){echo "checked";} echo">";
																	echo " Kompeten (K)&nbsp;&nbsp;&nbsp;
																	</label>
																	<label>";
																	echo "<input type='radio' class='minimal' name='pencapaian$el[id]' id='options2c1$el[id]' value='BK'";if ($jjw0['pencapaian']=="BK"){echo "checked";} echo">";
																...
																<div class='col-md-12'>
																	...
																	echo "<br><textarea name='penilaian_lanjut$el[id]' id='penilaian_lanjut$el[id]' class='form-control' placeholder='isikan penilaian lanjut alasan kenapa belum kompeten (bila belum kompeten)'>$jjw0[penilaian_lanjut]</textarea>";
																	echo "</div>
																</div></div>";
															}
															if ($jjw0['jawaban']==0){
				...
				<div class='col-md-4 col-sm-12 col-xs-12'>
						<a href='form-fr-ia-01.php?ida=$_GET[ida]&idj=$_GET[idj]' class='btn btn-primary form-control'>Unduh Form Hasil</a>
				</div>
				<div class='col-md-4 col-sm-12 col-xs-12'>
						<button type='submit' class='btn btn-success form-control' name='simpan'>Simpan Jawaban</button>
				</div>
	...
	{				
		...
		if ($cekak01>0){
			...
			if(empty($_POST['signed'])){
				...
				$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
				$alamatip=$_SERVER['REMOTE_ADDR'];
				$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.IA.03. PERTANYAAN UNTUK MENDUKUNG OBSERVASI','$_SESSION[namalengkap]','$file','$alamatip')";
				$conn->query($sqlinputdigisign);
				// input tanggapan pendukung observasi
				$sqlgetunitkompetensib2="SELECT * FROM `unit_kompetensi` WHERE `id_skemakkni`='$sk[id]'";
				$getunitkompetensib2=$conn->query($sqlgetunitkompetensib2);
				...
				while ($unkb2=$getunitkompetensib2->fetch_assoc()){
					...
					while ($gpp2=$getpertanyaan2->fetch_assoc()){
						//if (!empty($gpp2['pertanyaan'])){
							...
							$cekjawaban2=$conn->query($sqlcekjawaban2);
							$jjw2=$cekjawaban2->fetch_assoc();
							$sqlinputak01="INSERT INTO `asesmen_ia03`(`id_asesi`, `id_skemakkni`, `id_jadwal`, `id_unitkompetensi`, `id_pertanyaan`, `tanggapan`, `rekomendasi`) VALUES ('$_GET[ida]','$sk[id]','$_GET[idj]','$unkb2[id]','$gpp2[id]','".$_POST[$posttanggapan]."','".$_POST[$postrekomendasi]."')";
							$conn->query($sqlinputak01);
						//}
					}
				}
            ...
            <div class='box-body'>
              <!-- form start -->
            	<div class='box-body'>
					...
					while ($unkb=$getunitkompetensib->fetch_assoc()){
						...
						while ($gpp=$getpertanyaan->fetch_assoc()){
							if (!empty($gpp['pertanyaan'])){
								...
								<input type='radio' name='rekomendasi$gpp[id]' id='rekomendasi$gpp[id]1' value='K' required='required'";if ($jjw['rekomendasi']=='K'){echo " checked";}else{echo "";} echo ">&nbsp;Kompeten<br>
								<input type='radio' name='rekomendasi$gpp[id]' id='rekomendasi$gpp[id]2' value='BK' required='required'";if ($jjw['rekomendasi']=='BK'){echo " checked";}else{echo "";} echo ">&nbsp;Belum Kompeten</td></tr>
								<tr><td colspan='2'>Tanggapan:<br>
								<textarea class='form-control' name='tanggapan$gpp[id]'>";if (!empty($jjw['tanggapan'])){echo $jjw['tanggapan'];}else{echo "";} echo "</textarea>
								</td></tr>";
								$nopp++;
							}
						}
					...
					if (!empty($getk['umpan_balik_ia03'])){echo $getk['umpan_balik_ia03'];}else{echo "";}
					echo "</textarea>
					</div>";
					// cek tandatangan digital
					$url = "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
					...
					echo "<div class='box-footer bg-black'>
						...
						<div class='col-md-4 col-sm-12 col-xs-12'>
								<a href='form-fr-ia-03.php?ida=$_GET[ida]&idj=$_GET[idj]' class='btn btn-primary form-control'>Unduh Formulir</a>
						</div>
						<div class='col-md-4 col-sm-12 col-xs-12'>
								<button type='submit' class='btn btn-success form-control' name='simpan'>Simpan Jawaban</button>
						</div>
	...
	{				
		...
		if ($cekak01>0){
			...
			if(empty($_POST['signed'])){
				...
				$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
				$alamatip=$_SERVER['REMOTE_ADDR'];
				$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.IA.06. PERTANYAAN TERTULIS ESAI','$_SESSION[namalengkap]','$file','$alamatip')";
				$conn->query($sqlinputdigisign);
				// input jawaban pendukung observasi
				$sqlgetunitkompetensib2="SELECT * FROM `unit_kompetensi` WHERE `id_skemakkni`='$sk[id]'";
				$getunitkompetensib2=$conn->query($sqlgetunitkompetensib2);
					...
					while ($unkb=$getunitkompetensib->fetch_assoc()){
						...
						while ($gpp=$getpertanyaan->fetch_assoc()){
							if (!empty($gpp['pertanyaan'])){
								...
								$jjw=$cekjawaban->fetch_assoc();
								echo "<tr><td>$nopp.</td><td>".$gpp['pertanyaan']."</td><td rowspan='2'>
								<input type='radio' name='rekomendasi$gpp[id]' id='rekomendasi$gpp[id]1' value='K' ";if ($jjw['rekomendasi']=='K'){echo " checked";}else{echo "";} echo ">&nbsp;Kompeten<br>
								<input type='radio' name='rekomendasi$gpp[id]' id='rekomendasi$gpp[id]2' value='BK' ";if ($jjw['rekomendasi']=='BK'){echo " checked";}else{echo "";} echo ">&nbsp;Belum Kompeten</td></tr>
								<tr><td colspan='2'>Jawaban:<br>
								<textarea class='form-control' name='jawaban$gpp[id]' disabled>";if (!empty($jjw['jawaban'])){echo $jjw['jawaban'];}else{echo "";} echo "</textarea>
								</td></tr>";
								$nopp++;
							}
						}
	...
	{				
		...
		//if ($cekak01>0){
			...
			if(empty($_POST['signed'])){
				...
				while ($unkb2=$getunitkompetensib2->fetch_assoc()){
					...
					while ($gpp2=$getpertanyaan2->fetch_assoc()){
						//if (!empty($gpp2['pertanyaan'])){
							...
							if ($jumjjw2>0){
								$sqlinputak01="UPDATE `asesmen_ia07` SET `rekomendasi`='".$_POST[$postjawaban]."' WHERE `id_asesi`='$_GET[ida]' AND `id_skemakkni`='$jd[id_skemakkni]' AND `id_jadwal`='$_GET[idj]' AND `id_pertanyaan`='$gpp2[id]'";
								$conn->query($sqlinputak01);
							}else{
								$sqlinputak01="INSERT INTO `asesmen_ia07`(`id_asesi`, `id_skemakkni`, `id_jadwal`, `id_pertanyaan`,  `jawaban`, `rekomendasi`) VALUES ('$_GET[ida]', '$jd[id_skemakkni]', '$_GET[idj]', '$gpp2[id]', '".$_POST[$postjawaban]."', '".$_POST[$postrekomendasi]."')";
								$conn->query($sqlinputak01);
							}
						//}
					}
				...
				$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
				$alamatip=$_SERVER['REMOTE_ADDR'];
				$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.IA.07. PERTANYAAN LISAN','$_SESSION[namalengkap]','$file','$alamatip')";
				$conn->query($sqlinputdigisign);
				// input jawaban pendukung observasi
				$sqlgetunitkompetensib2="SELECT * FROM `unit_kompetensi` WHERE `id_skemakkni`='$sk[id]'";
				$getunitkompetensib2=$conn->query($sqlgetunitkompetensib2);
					...
					while ($unkb=$getunitkompetensib->fetch_assoc()){
						...
						while ($gpp=$getpertanyaan->fetch_assoc()){
							if (!empty($gpp['pertanyaan'])){
								...
								<textarea class='form-control' name='jawaban$gpp[id]'>";if (!empty($jjw['jawaban'])){echo $jjw['jawaban'];}else{echo "";} echo "</textarea>
								</td></tr>";
								$nopp++;
							}
						}
	...
	{				
		...
		if ($cekak01>0){
			...
			if(empty($_POST['signed'])){
				...
				//while ($unkb2=$getunitkompetensib2->fetch_assoc()){
					...
					while ($gpp2=$getpertanyaan2->fetch_assoc()){
						//if (!empty($gpp2['pertanyaan'])){
							...
							if ($jumjjw>0){
								$sqlinputak01="UPDATE `asesmen_ia08` SET `V`='".$_POST[$postjawabanV]."', `A`='".$_POST[$postjawabanA]."', `T`='".$_POST[$postjawabanT]."', `M`='".$_POST[$postjawabanM]."', `id_elemen`='".$_POST[$postelemen]."', `pertanyaan`='".$_POST[$postpertanyaan]."' WHERE `id_asesi`='$_GET[ida]' AND `id_skemakkni`='$jd[id_skemakkni]' AND `id_jadwal`='$_GET[idj]' AND `id_portfolio`='$gpp2[id]'";
								$conn->query($sqlinputak01);
							}else{
								$sqlinputak01="INSERT INTO `asesmen_ia08`(`id_asesi`, `id_skemakkni`, `id_jadwal`, `id_portfolio`, `V`, `A`, `T`, `M`, `id_elemen`, `pertanyaan`) VALUES ('$_GET[ida]', '$jd[id_skemakkni]', '$_GET[idj]', '$gpp2[id]', '".$_POST[$postjawabanV]."', '".$_POST[$postjawabanA]."', '".$_POST[$postjawabanT]."', '".$_POST[$postjawabanM]."', '".$_POST[$postelemen]."', '".$_POST[$postpertanyaan]."')";
								$conn->query($sqlinputak01);
							}
						//}
					}
				...
				$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
				$alamatip=$_SERVER['REMOTE_ADDR'];
				$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.IA.08. CEKLIS VERIFIKASI PORTOFOLIO','$_SESSION[namalengkap]','$file','$alamatip')";
				$conn->query($sqlinputdigisign);
				// input jawaban ceklist portfolio
				//$sqlgetunitkompetensib2="SELECT * FROM `unit_kompetensi` WHERE `id_skemakkni`='$sk[id]'";
				//$getunitkompetensib2=$conn->query($sqlgetunitkompetensib2);
			  ...
			  <!-- form start -->
				<div class='box-body'>
					...
					while ($unkb=$getunitkompetensib->fetch_assoc()){
						...
						$cekjawaban=$conn->query($sqlcekjawaban);
						$jjw=$cekjawaban->fetch_assoc();
						echo "<tr><td>$nopp</td><td>".$unkb['jenis_portfolio']."<br>".$unkb['nama_doc']."<br>".$unkb['peran_portfolio']."<br>Tanggal Dokumen: ".tgl_indo($unkb['tgl_doc'])."<br><a href='";if (substr($unkb['file'],0,4)=='http'){echo $unkb['file'];} else{echo "../foto_portfolio/".$unkb['file'];} echo "' target='_blank' class='btn btn-primary btn-xs'>Lihat Dokumen</a></td>
						<td><input type='radio' name='V".$unkb['id']."' id='V".$unkb['id']."_1' value='1' ";if ($jjw['V']=='1'){echo " checked";}else{echo "";} echo ">&nbsp;</td>
						<td><input type='radio' name='V".$unkb['id']."' id='V".$unkb['id']."_2' value='0' ";if ($jjw['V']=='0'){echo " checked";}else{echo "";} echo ">&nbsp;</td>
						<td><input type='radio' name='A".$unkb['id']."' id='A".$unkb['id']."_1' value='1' ";if ($jjw['A']=='1'){echo " checked";}else{echo "";} echo ">&nbsp;</td>
						<td><input type='radio' name='A".$unkb['id']."' id='A".$unkb['id']."_2' value='0' ";if ($jjw['A']=='0'){echo " checked";}else{echo "";} echo ">&nbsp;</td>
						<td><input type='radio' name='T".$unkb['id']."' id='T".$unkb['id']."_1' value='1' ";if ($jjw['T']=='1'){echo " checked";}else{echo "";} echo ">&nbsp;</td>
						<td><input type='radio' name='T".$unkb['id']."' id='T".$unkb['id']."_2' value='0' ";if ($jjw['T']=='0'){echo " checked";}else{echo "";} echo ">&nbsp;</td>
						<td><input type='radio' name='M".$unkb['id']."' id='M".$unkb['id']."_1' value='1' ";if ($jjw['M']=='1'){echo " checked";}else{echo "";} echo ">&nbsp;</td>
						<td><input type='radio' name='M".$unkb['id']."' id='M".$unkb['id']."_2' value='0' ";if ($jjw['M']=='0'){echo " checked";}else{echo "";} echo ">&nbsp;</td>
						</tr>";
						$nopp++;
					}
					echo "</tbody></table>";
					...
					while ($unkb2=$getunitkompetensib2->fetch_assoc()){
						...
						while ($getel=$getpertanyaanwawancara->fetch_assoc()){
							echo "<option value='$getel[id]'"; if ($jjwx['id_elemen']==$getel['id']){echo " selected";}else{echo "";} echo "><b>".$nount.". $getel[kode_unit] - $getel[judul]</b></option>";
							...
							while ($getel2=$getpertanyaanwawancara2->fetch_assoc()){
								echo "<option value='e-".$getel2['id']."'"; if ($jjwx['id_elemen']=="e-".$getel2['id']){echo " selected";}else{echo "";} echo ">--".$nount.".".$nountel.". $getel2[elemen_kompetensi]</option>";
								$nountel++;
							}
							$nount++;
						}
						echo "</select></td><td><textarea name='pertanyaan_".$unkb2['id']."' id='pertanyaan_".$unkb2['id']."' class='form-control'>"; if (!empty($jjwx['pertanyaan'])){echo $jjwx['pertanyaan'];}else{echo "";} echo "</textarea></td></tr>";
						$nopp2++;
					}
					echo "</tbody></table>";
					...
					<textarea name='buktitambahan' class='form-control'>";if (!empty($jjwr['buktitambahan'])){echo $jjwr['buktitambahan'];} echo "</textarea><br>
					Contoh :<br>
					<textarea name='contohbukti' class='form-control'>";if (!empty($jjwr['contohbukti'])){echo $jjwr['contohbukti'];} echo "</textarea></td>
					</tr>
					<tr><td rowspan='2'>Rekomendasi Asesor</td><td><input type='radio' name='rekomendasi' id='rekomendasi1' value='K' ";if ($jjwr['rekomendasi']=='K'){echo " checked";}else{echo "";} echo ">&nbsp;Asesi telah memenuhi pencapaian seluruh kriteria unjuk kerja, direkomendasikan <b>KOMPETEN</b></td></td></tr>
					<tr><td><input type='radio' name='rekomendasi' id='rekomendasi2' value='BK' ";if ($jjwr['rekomendasi']=='BK'){echo " checked";}else{echo "";} echo ">&nbsp;Asesi belum memenuhi pencapaian seluruh kriteria unjuk kerja, direkomendasikan uji demonstrasi pada:<br>
					<label>Unit</label><input type='text' name='unitbkrekom' class='form-control'";if (!empty($jjwr['unitbkrekom'])){echo " value='".$jjwr['unitbkrekom']."'";} echo "/><br>
					<label>Elemen</label><input type='text' name='elemenbkrekom' class='form-control'";if (!empty($jjwr['elemenbkrekom'])){echo " value='".$jjwr['elemenbkrekom']."'";} echo "/><br>
					<label>KUK</label><input type='text' name='kukbkrekom' class='form-control'";if (!empty($jjwr['kukbkrekom'])){echo " value='".$jjwr['kukbkrekom']."'";} echo "/><br></td></tr>
					</table>";
					// cek tandatangan digital
					$url = "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
					$iddokumen=md5($url);
	...
	{				
		...
		if ($cekak01>0){
			...
			if(empty($_POST['signed'])){
				...
				//while ($unkb2=$getunitkompetensib2->fetch_assoc()){
					...
					while ($gpp2=$getpertanyaan2->fetch_assoc()){
						//if (!empty($gpp2['pertanyaan'])){
							...
							$cekjawaban2=$conn->query($sqlcekjawaban2);
							$jjw2=$cekjawaban2->fetch_assoc();
							$sqlinputak01="UPDATE `asesmen_ia09` SET `jawaban`='".$_POST[$postjawaban]."', `rekomendasi`='".$_POST[$postrekomendasibukti]."' WHERE `id_asesi`='$_GET[ida]' AND `id_jadwal`='$_GET[idj]' `id_asesor`='$_SESSION[namauser]' AND `id_portfolio`='$gpp2[id]'";
							$conn->query($sqlinputak01);
						//}
					}
				//}
				...
				$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
				$alamatip=$_SERVER['REMOTE_ADDR'];
				$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.IA.09. PERTANYAAN WAWANCARA','$_SESSION[namalengkap]','$file','$alamatip')";
				$conn->query($sqlinputdigisign);
				// input jawaban ceklist portfolio
				//$sqlgetunitkompetensib2="SELECT * FROM `unit_kompetensi` WHERE `id_skemakkni`='$sk[id]'";
				//$getunitkompetensib2=$conn->query($sqlgetunitkompetensib2);
				...
				//while ($unkb2=$getunitkompetensib2->fetch_assoc()){
					...
					while ($gpp2=$getpertanyaan2->fetch_assoc()){
						//if (!empty($gpp2['pertanyaan'])){
							...
							$cekjawaban2=$conn->query($sqlcekjawaban2);
							$jjw2=$cekjawaban2->fetch_assoc();
							$sqlinputak01="INSERT INTO `asesmen_ia09`(`id_asesi`, `id_jadwal`, `id_asesor`, `id_portfolio`, `jawaban`, `rekomendasi`) VALUES ('$_GET[ida]','$_GET[idj]','$_SESSION[namauser]','$gpp2[id]','".$_POST[$postjawaban]."','".$_POST[$postrekomendasibukti]."')";
							$conn->query($sqlinputak01);
						//}
					}
				//}
			  ...
			  <!-- form start -->
				<div class='box-body'>
					...
					while ($unkb2=$getunitkompetensib2->fetch_assoc()){
						...
						if ($jumia09){
							$jjwx=$cekjawabanx->fetch_assoc();
							echo "<tr><td>$nopp2</td><td>Sesuai dengan bukti : $nopp2<br>$jjw[pertanyaan]</td><td><textarea name='jawaban_".$unkb2['id']."' id='jawaban_".$unkb2['id']."' class='form-control'>"; if (!empty($jjwx['jawaban'])){echo $jjwx['jawaban'];}else{echo "";} echo "</textarea></td>
							<td><input type='radio' name='rekomendasibukti_".$unkb2['id']."' id='rekomendasibukti".$unkb2['id']."_1' value='K' ";if ($jjwx['rekomendasi']=='K'){echo " checked";}else{echo "";} echo ">&nbsp;</td>
							<td><input type='radio' name='rekomendasibukti_".$unkb2['id']."' id='rekomendasibukti".$unkb2['id']."_2' value='BK' ";if ($jjwx['rekomendasi']=='BK'){echo " checked";}else{echo "";} echo ">&nbsp;</td>
							</tr>";
						}else{
	...
	{				
		...
		if ($cekak01>0){
			...
			if(empty($_POST['signed'])){
				...
				$escaped_url = htmlspecialchars( $url, ENT_QUOTES, 'UTF-8' );
				$alamatip=$_SERVER['REMOTE_ADDR'];
				$sqlinputdigisign="INSERT INTO `logdigisign`(`id_dokumen`, `url_ditandatangani`, `nama_dokumen`, `penandatangan`, `file`, `ip`) VALUES ('$iddokumen','$escaped_url','FR.IA.11. CEKLIS MENINJAU INSTRUMEN ASESMEN','$_SESSION[namalengkap]','$file','$alamatip')";
				$conn->query($sqlinputdigisign);
				// input ceklis meninjau instrumen asesmen
				/* $sqlgetunitkompetensib2="SELECT * FROM `unit_kompetensi` WHERE `id_skemakkni`='$sk[id]'";
				$getunitkompetensib2=$conn->query($sqlgetunitkompetensib2);
            ...
            <div class='box-body'>
              <!-- form start -->
            	<div class='box-body'>
					...
					while ($unkb=$getunitkompetensib->fetch_assoc()){ */
						...
						while ($gpp=$getpertanyaan->fetch_assoc()){
							if (!empty($gpp['pertanyaan'])){
								...
								<input type='radio' name='jawaban$gpp[id]' id='jawaban$gpp[id]1' value='Ya' required='required'";if ($jjw['jawaban']=='Ya'){echo " checked";}else{echo "";} echo ">&nbsp;Ya<br>
								<input type='radio' name='jawaban$gpp[id]' id='jawaban$gpp[id]2' value='Tidak' required='required'";if ($jjw['jawaban']=='Tidak'){echo " checked";}else{echo "";} echo ">&nbsp;Tidak</td>
								<td><textarea class='form-control' name='komentar$gpp[id]'>";if (!empty($jjw['komentar'])){echo $jjw['komentar'];}else{echo "";} echo "</textarea>
								</td></tr>";
								$nopp++;
							}
						}
					...
					if (!empty($getk['komentar_ia11'])){echo $getk['komentar_ia11'];}else{echo "";}
					echo "</textarea>
					</div>";
					// cek tandatangan digital
					$url = "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
        ...
        <div class='col-xs-12'>
          <div class='box'>
			...
			<div class='box-body'>";
				...
				echo "<tr><td><b>Periode</b></td><td colspan='3'><input type='radio' id='periode1' name='periode' value='1'"; if ($smapa1['periode']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Sebelum Asesmen</label>
						<br/><input type='radio' id='periode2' name='periode' value='2'"; if ($smapa1['periode']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Pada Saat Asesmen</label>
						<br/><input type='radio' id='periode3' name='periode' value='3'"; if ($smapa1['periode']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Setelah Asesmen</label></td></tr>
				...
				<table id='example9' class='table table-bordered table-striped'>
					...
					<tbody>
						...
						<tr>
							<td><div class='checkbox'><label><input type='checkbox' id='tujuan_1' name='tujuan_1' value='1'"; if ($smapa1['tujuan_1']=="1"){echo " checked";}else{echo "";} echo ">Bagian dari proses penjaminan mutu organisasi</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='konteks_1' name='konteks_1' value='1'"; if ($smapa1['konteks_1']=="1"){echo " checked";}else{echo "";} echo ">Internal organisasi</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='pendekatan_1' name='pendekatan_1' value='1'"; if ($smapa1['pendekatan_1']=="1"){echo " checked";}else{echo "";} echo ">Panel asesmen</label></div></td>
						</tr>
						<tr>
							<td><div class='checkbox'><label><input type='checkbox' id='tujuan_2' name='tujuan_2' value='1'"; if ($smapa1['tujuan_2']=="1"){echo " checked";}else{echo "";} echo ">Mengantisipasi risiko</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='konteks_2' name='konteks_2' value='1'"; if ($smapa1['konteks_2']=="1"){echo " checked";}else{echo "";} echo ">Eksternal organisasi</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='pendekatan_2' name='pendekatan_2' value='1'"; if ($smapa1['pendekatan_2']=="1"){echo " checked";}else{echo "";} echo ">Pertemuan moderasi</label></div></td>
						</tr>
						<tr>
							<td><div class='checkbox'><label><input type='checkbox' id='tujuan_3' name='tujuan_3' value='1'"; if ($smapa1['tujuan_3']=="1"){echo " checked";}else{echo "";} echo ">Memenuhi persyaratan BNSP</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='konteks_3' name='konteks_3' value='1'"; if ($smapa1['konteks_3']=="1"){echo " checked";}else{echo "";} echo ">Proses lisensi/re lisensi</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='pendekatan_3' name='pendekatan_3' value='1'"; if ($smapa1['pendekatan_3']=="1"){echo " checked";}else{echo "";} echo ">Mengkaji perangkat asesmen</label></div></td>
						</tr>
						<tr>
							<td><div class='checkbox'><label><input type='checkbox' id='tujuan_4' name='tujuan_4' value='1'"; if ($smapa1['tujuan_4']=="1"){echo " checked";}else{echo "";} echo ">Memastikan kesesuaian bukti-bukti</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='konteks_4' name='konteks_4' value='1'"; if ($smapa1['konteks_4']=="1"){echo " checked";}else{echo "";} echo ">Dengan kolega asesor</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='pendekatan_4' name='pendekatan_4' value='1'"; if ($smapa1['pendekatan_4']=="1"){echo " checked";}else{echo "";} echo ">Acuan pembanding</label></div></td>
						</tr>
						<tr>
							<td><div class='checkbox'><label><input type='checkbox' id='tujuan_5' name='tujuan_5' value='1'"; if ($smapa1['tujuan_5']=="1"){echo " checked";}else{echo "";} echo ">Meningkatkan kualitas asesmen</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='konteks_5' name='konteks_5' value='1'"; if ($smapa1['konteks_5']=="1"){echo " checked";}else{echo "";} echo ">Kolega dari organisasi pelatihan atau asesmen</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='pendekatan_5' name='pendekatan_5' value='1'"; if ($smapa1['pendekatan_5']=="1"){echo " checked";}else{echo "";} echo ">Pengujian lapangan dan uji coba perangkat asesmen</label></div></td>
						</tr>
						<tr>
							<td><div class='checkbox'><label><input type='checkbox' id='tujuan_6' name='tujuan_6' value='1'"; if ($smapa1['tujuan_6']=="1"){echo " checked";}else{echo "";} echo ">Mengevaluasi kualitas perangkat asesmen</label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='konteks_6' name='konteks_6' value='1'"; if ($smapa1['konteks_6']=="1"){echo " checked";}else{echo "";} echo "><input type='text' name='konteks_6b' class='form-control' "; if (!empty($smapa1['konteks_6b'])){echo "value='".$smapa1['konteks_6b']."'";} echo "></label></div></td>
							<td><div class='checkbox'><label><input type='checkbox' id='pendekatan_6' name='pendekatan_6' value='1'"; if ($smapa1['pendekatan_6']=="1"){echo " checked";}else{echo "";} echo ">Umpan balik dari klien</label></div></td>
						</tr>
						<tr>
							<td><div class='checkbox'><label><input type='checkbox' id='tujuan_7' name='tujuan_7' value='1'"; if ($smapa1['tujuan_7']=="1"){echo " checked";}else{echo "";} echo "><input type='text' name='tujuan_7b' class='form-control' "; if (!empty($smapa1['tujuan_7b'])){echo "value='".$smapa1['tujuan_7b']."'";} echo "></label></div></td>
							<td></td>
							<td></td>
						</tr>
						...
						<tr><td rowspan='3'><div class='checkbox'><label><input type='checkbox' id='askom' name='askom' value='1'"; if ($smapa1['askom']=="1"){echo " checked";}else{echo "";} echo ">Asesor kompetensi (wajib)</label></div></td><td><div class='input-group'><span class='input-group-addon'>1.</span><input type='text' name='orel_1' class='form-control' "; if (!empty($smapa1['orel_1'])){echo "value='".$smapa1['orel_1']."'";} echo "></div></td><td><textarea name='konfirmorel_1' class='form-control'>"; if (!empty($smapa1['konfirmorel_1'])){echo $smapa1['konfirmorel_1'];} echo "</textarea></td></tr>
						<tr><td><div class='input-group'><span class='input-group-addon'>2.</span><input type='text' name='orel_2' class='form-control' "; if (!empty($smapa1['orel_2'])){echo "value='".$smapa1['orel_2']."'";} echo "></div></td><td><textarea name='konfirmorel_2' class='form-control'>"; if (!empty($smapa1['konfirmorel_2'])){echo $smapa1['konfirmorel_2'];} echo "</textarea></td></tr>
						<tr><td><div class='input-group'><span class='input-group-addon'>3.</span><input type='text' name='orel_3' class='form-control' "; if (!empty($smapa1['orel_3'])){echo "value='".$smapa1['orel_3']."'";} echo "></div></td><td><textarea name='konfirmorel_3' class='form-control'>"; if (!empty($smapa1['konfirmorel_3'])){echo $smapa1['konfirmorel_3'];} echo "</textarea></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='leadasesor' name='leadasesor' value='1'"; if ($smapa1['leadasesor']=="1"){echo " checked";}else{echo "";} echo ">Lead Asesor</label></div></td><td><input type='text' name='nama_leadasesor' class='form-control' "; if (!empty($smapa1['nama_leadasesor'])){echo "value='".$smapa1['nama_leadasesor']."'";} echo "></td><td><textarea name='konfirmleadaseesor' class='form-control'>"; if (!empty($smapa1['konfirmleadaseesor'])){echo $smapa1['konfirmleadaseesor'];} echo "</textarea></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='manspv' name='manspv' value='1'"; if ($smapa1['manspv']=="1"){echo " checked";}else{echo "";} echo ">Manajer, supervisor</label></div></td><td><input type='text' name='nama_manspv' class='form-control' "; if (!empty($smapa1['nama_manspv'])){echo "value='".$smapa1['nama_manspv']."'";} echo "></td><td><textarea name='konfirmmanspv' class='form-control'>"; if (!empty($smapa1['konfirmmanspv'])){echo $smapa1['konfirmmanspv'];} echo "</textarea></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='tenagaahli' name='tenagaahli' value='1'"; if ($smapa1['tenagaahli']=="1"){echo " checked";}else{echo "";} echo ">Tenaga ahli di bidangnya</label></div></td><td><input type='text' name='nama_tenagaahli' class='form-control' "; if (!empty($smapa1['nama_tenagaahli'])){echo "value='".$smapa1['nama_tenagaahli']."'";} echo "></td><td><textarea name='konfirmtenagaahli' class='form-control'>"; if (!empty($smapa1['konfirmtenagaahli'])){echo $smapa1['konfirmtenagaahli'];} echo "</textarea></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='koordtraining' name='koordtraining' value='1'"; if ($smapa1['koordtraining']=="1"){echo " checked";}else{echo "";} echo ">Koord. Pelatihan</label></div></td><td><input type='text' name='nama_koordtraining' class='form-control' "; if (!empty($smapa1['nama_koordtraining'])){echo "value='".$smapa1['nama_koordtraining']."'";} echo "></td><td><textarea name='konfirmkoordtraining' class='form-control'>"; if (!empty($smapa1['konfirmkoordtraining'])){echo $smapa1['konfirmkoordtraining'];} echo "</textarea></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='asosiasi' name='asosiasi' value='1'"; if ($smapa1['asosiasi']=="1"){echo " checked";}else{echo "";} echo ">Anggota asosiasi industri/profesi</label></div></td><td><input type='text' name='nama_asosiasi' class='form-control' "; if (!empty($smapa1['nama_asosiasi'])){echo "value='".$smapa1['nama_asosiasi']."'";} echo "></td><td><textarea name='konfirmasosiasi' class='form-control'>"; if (!empty($smapa1['konfirmasosiasi'])){echo $smapa1['konfirmasosiasi'];} echo "</textarea></td></tr>
						<tr><td><b>Acuan Pembanding:</b></td><td colspan='2'><b>Dokumen terkait dan bahan-bahan</b></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='stdkom' name='stdkom' value='1'"; if ($smapa1['stdkom']=="1"){echo " checked";}else{echo "";} echo ">Standar Kompetensi</label></div></td><td colspan='2'><div class='checkbox'><label><input type='checkbox' id='skema' name='skema' value='1'"; if ($smapa1['skema']=="1"){echo " checked";}else{echo "";} echo ">Skema sertifikasi</label></div></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='sop' name='sop' value='1'"; if ($smapa1['sop']=="1"){echo " checked";}else{echo "";} echo ">SOP/IK</label></div></td><td colspan='2'><div class='checkbox'><label><input type='checkbox' id='skk' name='skk' value='1'"; if ($smapa1['skk']=="1"){echo " checked";}else{echo "";} echo ">SKKNI/SK3/SKI</label></div></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='manualbook' name='manualbook' value='1'"; if ($smapa1['manualbook']=="1"){echo " checked";}else{echo "";} echo ">Manual Instruction/book</label></div></td><td colspan='2'><div class='checkbox'><label><input type='checkbox' id='perangkat' name='perangkat' value='1'"; if ($smapa1['perangkat']=="1"){echo " checked";}else{echo "";} echo ">Perangkat asesmen</label></div></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='stdkinerja' name='stdkinerja' value='1'"; if ($smapa1['stdkinerja']=="1"){echo " checked";}else{echo "";} echo ">Standar Kinerja</label></div></td><td colspan='2'><div class='checkbox'><label><input type='checkbox' id='peraturan' name='peraturan' value='1'"; if ($smapa1['peraturan']=="1"){echo " checked";}else{echo "";} echo ">Peraturan/Pedoman</label></div></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='lainnya' name='lainnya' value='1'"; if ($smapa1['lainnya']=="1"){echo " checked";}else{echo "";} echo "><input type='text' name='nama_lainnya' class='form-control' "; if (!empty($smapa1['nama_lainnya'])){echo "value='".$smapa1['nama_lainnya']."'";} echo "></label></div></td><td colspan='2'></td></tr>
					</tbody>
				</table>
				<table id='example9' class='table table-bordered table-striped'>
					<thead>
					...
					<tbody>
						<tr><td rowspan='4'></td><td rowspan='4'>Keterampilan komunikasi yang digunakan dalam kegiatan validasi :</td><td><div class='checkbox'><label><input type='checkbox' id='proaktif' name='proaktif' value='1'"; if ($smapa1['proaktif']=="1"){echo " checked";}else{echo "";} echo ">PRO AKTIF</label></div></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='activelistening' name='activelistening' value='1'"; if ($smapa1['activelistening']=="1"){echo " checked";}else{echo "";} echo ">ACTIVE LISTENING</label></div></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='keterampilan1' name='keterampilan1' value='1'"; if ($smapa1['keterampilan1']=="1"){echo " checked";}else{echo "";} echo "><input type='text' name='nama_ketlainnya1' class='form-control' "; if (!empty($smapa1['nama_ketlainnya1'])){echo "value='".$smapa1['nama_ketlainnya1']."'";} echo "></label></div></td></tr>
						<tr><td><div class='checkbox'><label><input type='checkbox' id='keterampilan2' name='keterampilan2' value='1'"; if ($smapa1['keterampilan2']=="1"){echo " checked";}else{echo "";} echo "><input type='text' name='nama_ketlainnya2' class='form-control' "; if (!empty($smapa1['nama_ketlainnya2'])){echo "value='".$smapa1['nama_ketlainnya2']."'";} echo "></label></div></td></tr>
					</tbody>
				</table>
				<table id='example9' class='table table-bordered table-striped'>
					<thead>
					...
					<tbody>
						<tr><td>1.</td><td>Proses Asesmen</td><td><input type='checkbox' id='ab1v' name='ab1v' value='1'"; if ($smapa1['ab1v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab1a' name='ab1a' value='1'"; if ($smapa1['ab1a']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab1t' name='ab1t' value='1'"; if ($smapa1['ab1t']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab1m' name='ab1m' value='1'"; if ($smapa1['ab1m']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa1v' name='pa1v' value='1'"; if ($smapa1['pa1v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa1r' name='pa1r' value='1'"; if ($smapa1['pa1r']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa1f' name='pa1f' value='1'"; if ($smapa1['pa1f']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa1f2' name='pa1f2' value='1'"; if ($smapa1['pa1f2']=="1"){echo " checked";}else{echo "";} echo "></td></tr>
						<tr><td>2.</td><td>Rencana asesmen</td><td><input type='checkbox' id='ab2v' name='ab2v' value='1'"; if ($smapa1['ab2v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab2a' name='ab2a' value='1'"; if ($smapa1['ab2a']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab2t' name='ab2t' value='1'"; if ($smapa1['ab2t']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab2m' name='ab2m' value='1'"; if ($smapa1['ab2m']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa2v' name='pa2v' value='1'"; if ($smapa1['pa2v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa2r' name='pa2r' value='1'"; if ($smapa1['pa2r']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa2f' name='pa2f' value='1'"; if ($smapa1['pa2f']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa2f2' name='pa2f2' value='1'"; if ($smapa1['pa2f2']=="1"){echo " checked";}else{echo "";} echo "></td></tr>
						<tr><td>3.</td><td>Interpretasi standar kompetensi</td><td><input type='checkbox' id='ab3v' name='ab3v' value='1'"; if ($smapa1['ab3v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab3a' name='ab3a' value='1'"; if ($smapa1['ab3a']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab3t' name='ab3t' value='1'"; if ($smapa1['ab3t']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab3m' name='ab3m' value='1'"; if ($smapa1['ab3m']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa3v' name='pa3v' value='1'"; if ($smapa1['pa3v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa3r' name='pa3r' value='1'"; if ($smapa1['pa3r']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa3f' name='pa3f' value='1'"; if ($smapa1['pa3f']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa3f2' name='pa3f2' value='1'"; if ($smapa1['pa3f2']=="1"){echo " checked";}else{echo "";} echo "></td></tr>
						<tr><td>4.</td><td>Interpretasi acuan pembanding lainnya</td><td><input type='checkbox' id='ab4v' name='ab4v' value='1'"; if ($smapa1['ab4v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab4a' name='ab4a' value='1'"; if ($smapa1['ab4a']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab4t' name='ab4t' value='1'"; if ($smapa1['ab4t']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab4m' name='ab4m' value='1'"; if ($smapa1['ab4m']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa4v' name='pa4v' value='1'"; if ($smapa1['pa4v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa4r' name='pa4r' value='1'"; if ($smapa1['pa4r']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa4f' name='pa4f' value='1'"; if ($smapa1['pa4f']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa4f2' name='pa4f2' value='1'"; if ($smapa1['pa4f2']=="1"){echo " checked";}else{echo "";} echo "></td></tr>
						<tr><td>5.</td><td>Penyeleksian dan penerapan metode asesmen</td><td><input type='checkbox' id='ab5v' name='ab5v' value='1'"; if ($smapa1['ab5v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab5a' name='ab5a' value='1'"; if ($smapa1['ab5a']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab5t' name='ab5t' value='1'"; if ($smapa1['ab5t']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab5m' name='ab5m' value='1'"; if ($smapa1['ab5m']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa5v' name='pa5v' value='1'"; if ($smapa1['pa5v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa5r' name='pa5r' value='1'"; if ($smapa1['pa5r']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa5f' name='pa5f' value='1'"; if ($smapa1['pa5f']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa5f2' name='pa5f2' value='1'"; if ($smapa1['pa5f2']=="1"){echo " checked";}else{echo "";} echo "></td></tr>
						<tr><td>6.</td><td>Penyeleksian dan penerapan perangkat asesmen</td><td><input type='checkbox' id='ab6v' name='ab6v' value='1'"; if ($smapa1['ab6v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab6a' name='ab6a' value='1'"; if ($smapa1['ab6a']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab6t' name='ab6t' value='1'"; if ($smapa1['ab6t']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab6m' name='ab6m' value='1'"; if ($smapa1['ab6m']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa6v' name='pa6v' value='1'"; if ($smapa1['pa6v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa6r' name='pa6r' value='1'"; if ($smapa1['pa6r']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa6f' name='pa6f' value='1'"; if ($smapa1['pa6f']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa6f2' name='pa6f2' value='1'"; if ($smapa1['pa6f2']=="1"){echo " checked";}else{echo "";} echo "></td></tr>
						<tr><td>7.</td><td>Bukti-bukti yang dikumpulkan</td><td><input type='checkbox' id='ab7v' name='ab7v' value='1'"; if ($smapa1['ab7v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab7a' name='ab7a' value='1'"; if ($smapa1['ab7a']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab7t' name='ab7t' value='1'"; if ($smapa1['ab7t']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab7m' name='ab7m' value='1'"; if ($smapa1['ab7m']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa7v' name='pa7v' value='1'"; if ($smapa1['pa7v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa7r' name='pa7r' value='1'"; if ($smapa1['pa7r']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa7f' name='pa7f' value='1'"; if ($smapa1['pa7f']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa7f2' name='pa7f2' value='1'"; if ($smapa1['pa7f2']=="1"){echo " checked";}else{echo "";} echo "></td></tr>
						<tr><td>8.</td><td>Proses pengambilan keputusan</td><td><input type='checkbox' id='ab8v' name='ab8v' value='1'"; if ($smapa1['ab8v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab8a' name='ab8a' value='1'"; if ($smapa1['ab8a']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab8t' name='ab8t' value='1'"; if ($smapa1['ab8t']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='ab8m' name='ab8m' value='1'"; if ($smapa1['ab8m']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa8v' name='pa8v' value='1'"; if ($smapa1['pa8v']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa8r' name='pa8r' value='1'"; if ($smapa1['pa8r']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa8f' name='pa8f' value='1'"; if ($smapa1['pa8f']=="1"){echo " checked";}else{echo "";} echo "></td><td><input type='checkbox' id='pa8f2' name='pa8f2' value='1'"; if ($smapa1['pa8f2']=="1"){echo " checked";}else{echo "";} echo "></td></tr>
					</tbody>
				</table>
				</div><!--overflow-->
			</div><!--box body-->
        ...
        <div class='col-xs-12'>
          <div class='box'>
			...
			<tr><td rowspan='7'><b>1.1.</b></td><td>Kandidat</td><td colspan='2'>
				<input type='radio' id='kandidat1' name='kandidat' value='1'"; if ($smapa1['pendekatan']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Hasil pelatihan dan / atau pendidikan:</label>&nbsp;<input type='text' name='kandidatket1' value='$smapa1[pendekatan_ket]' class='form-control' placeholder='nama lembaga pelatihan/pendidikan'/>
				<br/><input type='radio' id='kandidat2' name='kandidat' value='2'"; if ($smapa1['pendekatan']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Pekerja berpengalaman&nbsp;</label>
				<br/><input type='radio' id='kandidat3' name='kandidat' value='3'"; if ($smapa1['pendekatan']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Pelatihan / belajar mandiri&nbsp;</label>
			</td></tr>
			<tr><td>Tujuan Asesmen</td><td colspan='2'>
				<input type='radio' id='tujuanassesmen1' name='tujuanasesmen' value='1'"; if ($smapa1['tujuan']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Sertifikasi</label>
				<br/><input type='radio' id='tujuanassesmen2' name='tujuanasesmen' value='2'"; if ($smapa1['tujuan']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Sertifikasi Ulang</label>
				<br/><input type='radio' id='tujuanassesmen3' name='tujuanasesmen' value='3'"; if ($smapa1['tujuan']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Pengakuan Kompetensi Terkini (PKT)</label>
				<br/><input type='radio' id='tujuanassesmen4' name='tujuanasesmen' value='4'"; if ($smapa1['tujuan']=="4"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Rekognisi Pembelajaran Lampau</label>
				<br/><input type='radio' id='tujuanassesmen5' name='tujuanasesmen' value='5'"; if ($smapa1['tujuan']=="5"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Lainnya</label>&nbsp;<input type='text' name='tujuanket' value='$smapa1[tujuanket]' class='form-control'/>
			</td></tr>
			<tr><td rowspan='4'>Konteks Asesmen</td><td>Lingkungan</td><td>
				<input type='radio' id='lingkungan1' name='lingkungan' value='1'"; if ($smapa1['konteks_a']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Tempat kerja nyata</label>
				<br/><input type='radio' id='lingkungan2' name='lingkungan' value='2'"; if ($smapa1['konteks_a']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Tempat kerja simulasi</label>
			</td></tr>
			<tr><td>Peluang untuk mengumpulkan bukti dalam sejumlah situasi</td><td>
				<input type='radio' id='peluang1' name='peluang' value='1'"; if ($smapa1['konteks_b']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Tersedia</label>
				<br/><input type='radio' id='peluang2' name='peluang' value='2'"; if ($smapa1['konteks_b']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Terbatas</label>
			</td></tr>
			<tr><td>Hubungan antara standar kompetensi dan:</td><td>
				<input type='checkbox' id='hubungan1' name='hubungan1' value='1'"; if ($smapa1['konteks_c1']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Bukti untuk mendukung asesmen / RPL: </label>
				<br/><input type='checkbox' id='hubungan2' name='hubungan2' value='2'"; if ($smapa1['konteks_c2']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Aktivitas kerja di tempat kerja Asesi: </label>
				<br/><input type='checkbox' id='hubungan3' name='hubungan3' value='3'"; if ($smapa1['konteks_c3']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Kegiatan Pembelajaran: </label>
			</td></tr>
			<tr><td>Siapa yang melakukan asesmen / RPL</td><td><input type='radio' id='siapa1' name='siapa' value='1'"; if ($smapa1['konteks_d']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Lembaga Sertifikasi</label>
				<br/><input type='radio' id='siapa2' name='siapa' value='2'"; if ($smapa1['konteks_d']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Organisasi Pelatihan</label>
				<br/><input type='radio' id='siapa3' name='siapa' value='3'"; if ($smapa1['konteks_d']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Asesor Perusahaan</label>
			</td></tr>
			<tr><td>Konfirmasi dengan orang yang relevan</td><td colspan='2'>
				<input type='checkbox' id='konfirmasi1' name='konfirmasi1' value='1'"; if ($smapa1['konfirmasi1']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Manajer sertifikasi LSP</label>
				<br/><input type='checkbox' id='konfirmasi2' name='konfirmasi2' value='2'"; if ($smapa1['konfirmasi2']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Master Asesor / Master Trainer / Asesor Utama Kompetensi</label>
				<br/><input type='checkbox' id='konfirmasi3' name='konfirmasi3' value='3'"; if ($smapa1['konfirmasi3']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Manajer Pelatihan Lembaga Training terakreditasi / Lembaga Training terdaftar</label>
				<br/><input type='checkbox' id='konfirmasi4' name='konfirmasi4' value='4'"; if ($smapa1['konfirmasi4']=="4"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Lainnya:</label>&nbsp;<input type='text' name='konfirmasiket' value='$smapa1[konfirmasi4_ket]' class='form-control'/>
			</td></tr>
			<tr><td>1.2.</td><td>Tolok Ukur Asesmen</td><td colspan='2'>
				<input type='checkbox' id='tolokukur1' name='tolokukur1' value='1'"; if ($smapa1['toluk1']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Standar Kompetensi: SKKNI</label>&nbsp;<input type='text' name='tolokukur1ket' value='$smapa1[toluk1_ket]' class='form-control' placeholder='bila ada, isikan nomor SKKNI/SKK/SI'/>
				<br/><input type='checkbox' id='tolokukur2' name='tolokukur2' value='2'"; if ($smapa1['toluk2']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Kriteria asesmen dari kurikulum pelatihan</label>&nbsp;<input type='text' name='tolokukur2ket' value='$smapa1[toluk2_ket]' class='form-control' placeholder='bila ada, isikan acuan/judul kurikulum pelatihan'/>
				<br/><input type='checkbox' id='tolokukur3' name='tolokukur3' value='3'"; if ($smapa1['toluk3']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Spesifikasi kinerja suatu perusahaan atau industri:</label>&nbsp;<input type='text' name='tolokukur3ket' value='$smapa1[toluk3_ket]' class='form-control' placeholder='bila ada, isikan acuan spesifikasi kinerja/perusahaan'/>
				<br/><input type='checkbox' id='tolokukur4' name='tolokukur4' value='4'"; if ($smapa1['toluk4']=="4"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Spesifikasi Produk:</label>&nbsp;<input type='text' name='tolokukur4ket' value='$smapa1[toluk4_ket]' class='form-control' placeholder='bila ada, isikan acuan spesifikasi produk'/>
				<br/><input type='checkbox' id='tolokukur5' name='tolokukur5' value='5'"; if ($smapa1['toluk5']=="5"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Pedoman khusus:</label>&nbsp;<input type='text' name='tolokukur5ket' value='$smapa1[toluk5_ket]' class='form-control' placeholder='bila ada, isikan acuan nomor/judul pedoman khusus'/>
			</td></tr>
			</tbody>
			</div>
			<div style='overflow-x:auto;'>
						...
						while ($gel=$getelemen->fetch_assoc()){
							...
							while ($gkuk=$getkuk->fetch_assoc()){
								...
								echo "<tr><td>$gkuk[kriteria]</td>
									...
									<td><input type='checkbox' name='L_$noun$noel$nokuk' value='L'"; if ($smapa1b['bukti_L']=="L"){echo " checked";}else{echo "";} echo "></td>
									<td><input type='checkbox' name='TL_$noun$noel$nokuk' value='TL'"; if ($smapa1b['bukti_TL']=="TL"){echo " checked";}else{echo "";} echo "></td>
									<td><input type='checkbox' name='T_$noun$noel$nokuk' value='T'"; if ($smapa1b['bukti_T']=="T"){echo " checked";}else{echo "";} echo "></td>
									<td><select name='met1_$noun$noel$nokuk' class='form-control'>
										<option value=''>-</option>
										<option value='CL'"; if ($smapa1b['metode1']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode1']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode1']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode1']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode1']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode1']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode1']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
									<td><select name='met2_$noun$noel$nokuk' class='form-control'>
										<option value=''>-</option>
										<option value='CL'"; if ($smapa1b['metode2']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode2']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode2']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode2']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode2']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode2']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode2']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
									<td><select name='met3_$noun$noel$nokuk' class='form-control'>
										<option value=''>-</option>
										<option value='CL'"; if ($smapa1b['metode3']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode3']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode3']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode3']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode3']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode3']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode3']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
									<td><select name='met4_$noun$noel$nokuk' class='form-control'>
										<option value=''>-</option>
										<option value='CL'"; if ($smapa1b['metode4']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode4']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode4']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode4']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode4']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode4']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode4']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
									<td><select name='met5_$noun$noel$nokuk' class='form-control'>
										<option value=''>-</option>
										<option value='CL'"; if ($smapa1b['metode5']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode5']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode5']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode5']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode5']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode5']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode5']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
									<td><select name='met6_$noun$noel$nokuk' class='form-control'>
										<option value=''>-</option>
										<option value='CL'"; if ($smapa1b['metode6']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode6']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode6']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode6']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode6']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode6']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode6']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
								</tr>";
								$nokuk++;
							}
			...
			echo "<div style='overflow-x:auto;'>
				...
				<tbody>
					<tr><td>3.1</td><td>a. Karakteristik Kandidat:</td><td><input type='radio' id='31a1' name='31a' value='1'"; if ($smapa1['modkon1a']=="1"){echo " checked";}else{echo "";} echo "><label>Ada</label>&nbsp;&nbsp;&nbsp;<input type='radio' id='31a2' name='31a' value='0'"; if ($smapa1['modkon1a']=="0"){echo " checked";}else{echo "";} echo "><label>Tidak Ada</label>&nbsp;karakteristik khusus Kandidat<br>Jika Ada, tuliskan <input type='text' name='31a_ket' class='form-control' value='$smapa1[modkon1a_ket]'/></td></tr>
					<tr><td></td><td>b. Kebutuhan kontekstualisasi terkait tempat kerja:</td><td><input type='radio' id='31b1' name='31b' value='1'"; if ($smapa1['modkon1b']=="1"){echo " checked";}else{echo "";} echo "><label>Ada</label>&nbsp;&nbsp;&nbsp;<input type='radio' id='31b2' name='31b' value='0'"; if ($smapa1['modkon1b']=="0"){echo " checked";}else{echo "";} echo "><label>Tidak Ada</label>&nbsp;kebutuhan kontekstualisasi<br>Jika Ada, tuliskan <input type='text' name='31b_ket' class='form-control' value='$smapa1[modkon1b_ket]'/></td></tr>
					<tr><td>3.2</td><td>Saran yang diberikan oleh paket pelatihan atau pengembang pelatihan</td><td><input type='radio' id='321' name='32' value='1'"; if ($smapa1['modkon2']=="1"){echo " checked";}else{echo "";} echo "><label>Ada</label>&nbsp;&nbsp;&nbsp;<input type='radio' id='322' name='32' value='0'"; if ($smapa1['modkon2']=="0"){echo " checked";}else{echo "";} echo "><label>Tidak Ada</label>&nbsp;saran<br>Jika Ada, tuliskan <input type='text' name='32_ket' class='form-control' value='$smapa1[modkon2_ket]'/></td></tr>
					<tr><td>3.3</td><td>Penyesuaian perangkat asesmen terkait kebutuhan kontekstualisasi</td><td><input type='radio' id='331' name='33' value='1'"; if ($smapa1['modkon3']=="1"){echo " checked";}else{echo "";} echo "><label>Ada</label>&nbsp;&nbsp;&nbsp;<input type='radio' id='332' name='33' value='0'"; if ($smapa1['modkon3']=="0"){echo " checked";}else{echo "";} echo "><label>Tidak Ada</label>&nbsp;penyesuaian perangkat<br>Jika Ada, tuliskan <input type='text' name='33_ket' class='form-control' value='$smapa1[modkon3_ket]'/></td></tr>
					<tr><td>3.4</td><td>Peluang untuk kegiatan asesmen terintegrasi dan mencatat setiap perubahan yang diperlukan untuk alat asesmen</td><td><input type='radio' id='341' name='34' value='1'"; if ($smapa1['modkon4']=="1"){echo " checked";}else{echo "";} echo "><label>Ada</label>&nbsp;&nbsp;&nbsp;<input type='radio' id='342' name='34' value='0'"; if ($smapa1['modkon4']=="0"){echo " checked";}else{echo "";} echo "><label>Tidak Ada</label>&nbsp;peluang<br>Jika Ada, tuliskan <input type='text' name='34_ket' class='form-control' value='$smapa1[modkon4_ket]'/></td></tr>
				</tbody>
			</table></div>";
			echo "<div style='overflow-x:auto;'>
				<table id='example9' class='table table-bordered table-striped'>
				...
				<tbody>
					<tr><td><input type='checkbox' name='konf1' value='1'"; if ($smapa1['konfirm1']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Manajer sertifikasi LSP</label></td><td><input type='text' name='nama_konf1' class='form-control' placeholder='nama personil' value='$smapa1[konfirm1_ket]'/></td></tr>
					<tr><td><input type='checkbox' name='konf2' value='1'"; if ($smapa1['konfirm2']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Master Asesor / Master Trainer / Lead Asesor/ Asesor Utama Kompetensi</label></td><td><input type='text' name='nama_konf2' class='form-control' placeholder='nama personil' value='$smapa1[konfirm2_ket]'/></td></tr>
					<tr><td><input type='checkbox' name='konf3' value='1'"; if ($smapa1['konfirm3']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Manajer pelatihan Lembaga Training terakreditasi / Lembaga Training terdaftar</label></td><td><input type='text' name='nama_konf3' class='form-control' placeholder='nama personil' value='$smapa1[konfirm3_ket]'/></td></tr>
					<tr><td><input type='checkbox' name='konf4' value='1'"; if ($smapa1['konfirm4']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Lainnya:</label></td><td><input type='text' name='nama_konf4' class='form-control' placeholder='nama personil' value='$smapa1[konfirm4_ket]'/></td></tr>
				</tbody>
			</table>";
			echo "</div>
			</div>
			<div class='box-footer'>
				...
				<div class='col-md-4 col-sm-12 col-xs-12'>
					<a href='../asesor/form-mapa-01.php?idsk=$_GET[idsk]' class='btn btn-primary form-control'>Unduh Form MAPA-01</a>
				</div>
				<div class='col-md-4 col-sm-12 col-xs-12'>
					<button type='submit' class='btn btn-success form-control' name='simpan'>Simpan Jawaban</button>
				</div>
          ...
          <div class='box'>
			...
			<div class='box-body'>";
				...
				<tbody>
					...
					<tr><td>Hubungan antara standar kompetensi dan:</td><td>
						<input type='checkbox' id='hubungan1' name='hubungan1' value='1'"; if ($smapa1['konteks_c1']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Bukti untuk mendukung asesmen / RPL: </label><input type='radio' id='hubungan1a' name='hubungan1-1' value='1'"; if ($smapa1['konteks_c1-1']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<img src='../images/faceicon-like.jpg' width='18px'/>&nbsp;&nbsp;&nbsp;<input type='radio' id='hubungan1b' name='hubungan1-1' value='2'"; if ($smapa1['konteks_c1-1']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<img src='../images/faceicon-neutral.jpg' width='18px'/>&nbsp;&nbsp;&nbsp;<input type='radio' id='hubungan1c' name='hubungan1-1' value='3'"; if ($smapa1['konteks_c1-1']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<img src='../images/faceicon-dislike.jpg' width='18px'/>
						<br/><input type='checkbox' id='hubungan2' name='hubungan2' value='2'"; if ($smapa1['konteks_c2']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Aktivitas kerja di tempat kerja Asesi: </label><input type='radio' id='hubungan2a' name='hubungan2-1' value='1'"; if ($smapa1['konteks_c2-1']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<img src='../images/faceicon-like.jpg' width='18px'/>&nbsp;&nbsp;&nbsp;<input type='radio' id='hubungan2b' name='hubungan2-1' value='2'"; if ($smapa1['konteks_c2-1']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<img src='../images/faceicon-neutral.jpg' width='18px'/>&nbsp;&nbsp;&nbsp;<input type='radio' id='hubungan2c' name='hubungan2-1' value='3'"; if ($smapa1['konteks_c2-1']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<img src='../images/faceicon-dislike.jpg' width='18px'/>
						<br/><input type='checkbox' id='hubungan3' name='hubungan3' value='3'"; if ($smapa1['konteks_c3']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Kegiatan Pembelajaran: </label><input type='radio' id='hubungan3a' name='hubungan3-1' value='1'"; if ($smapa1['konteks_c3-1']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<img src='../images/faceicon-like.jpg' width='18px'/>&nbsp;&nbsp;&nbsp;<input type='radio' id='hubungan3b' name='hubungan3-1' value='2'"; if ($smapa1['konteks_c3-1']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<img src='../images/faceicon-neutral.jpg' width='18px'/>&nbsp;&nbsp;&nbsp;<input type='radio' id='hubungan3c' name='hubungan3-1' value='3'"; if ($smapa1['konteks_c3-1']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<img src='../images/faceicon-dislike.jpg' width='18px'/>
					</td></tr>
					<tr><td>Siapa yang melakukan asesmen / RPL</td><td><input type='radio' id='siapa1' name='siapa' value='1'"; if ($smapa1['konteks_d']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Lembaga Sertifikasi</label>
						<br/><input type='radio' id='siapa2' name='siapa' value='2'"; if ($smapa1['konteks_d']=="2"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Organisasi Pelatihan</label>
						<br/><input type='radio' id='siapa3' name='siapa' value='3'"; if ($smapa1['konteks_d']=="3"){echo " checked";}else{echo "";} echo ">&nbsp;<label>Asesor Perusahaan</label>
			...
			<div class='box-footer'>
				...
				<div class='col-md-4 col-sm-12 col-xs-12'>
					<a href='../asesor/form-mapa-01.php?kand=$_GET[kand]&idsk=$_GET[idsk]' class='btn btn-primary form-control'>Unduh Form MAPA-01</a>
				</div>
				<div class='col-md-4 col-sm-12 col-xs-12'>
					<input type='submit' class='btn btn-success form-control' name='simpan' value='Simpan & Lanjut Berikutnya'/>
				</div>
        ...
        <div class='col-xs-12'>
          <div class='box'>
			...
			<table id='example9' class='table table-bordered table-striped'>
				...
				$sqlgetunit="SELECT * FROM `unit_kompetensi` WHERE `id_skemakkni`='$_GET[idsk]' ORDER BY `kode_unit` ASC";
				$getunit=$conn->query($sqlgetunit);
				$noun=1;
				while ($gtu=$getunit->fetch_assoc()){
					echo "<hr><div style='overflow-x:auto;'>
						...
						while ($gel=$getelemen->fetch_assoc()){
							...
							while ($gkuk=$getkuk->fetch_assoc()){
								if (!empty($_GET['kand'])){
									$sqlgetskemamapa1b="SELECT * FROM `skema_mapa1b` WHERE `id_skemakkni`='$_GET[idsk]' AND `profil_kandidat`='$_GET[kand]' AND `id_unitkompetensi`='$gtu[id]' AND `id_elemenkompetensi`='$gel[id]' AND `id_kriteria`='$gkuk[id]' ORDER BY `id` ASC";
								}else{
									$sqlgetskemamapa1b="SELECT * FROM `skema_mapa1b` WHERE `id_skemakkni`='$_GET[idsk]' AND `id_unitkompetensi`='$gtu[id]' AND `id_elemenkompetensi`='$gel[id]' AND `id_kriteria`='$gkuk[id]' ORDER BY `id` ASC";
								}
								$getskemamapa1b=$conn->query($sqlgetskemamapa1b);
								$smapa1b=$getskemamapa1b->fetch_assoc();
								echo "<tr><td rowspan='2'>$gkuk[kriteria]</td>
									<td><textarea name='bukti_$noun$noel$nokuk' class='form-control'>$smapa1b[ket_bukti]</textarea></td>
									<td><input type='checkbox' name='L_$noun$noel$nokuk' value='L'"; if ($smapa1b['bukti_L']=="L"){echo " checked";}else{echo "";} echo "></td>
									<td><input type='checkbox' name='TL_$noun$noel$nokuk' value='TL'"; if ($smapa1b['bukti_TL']=="TL"){echo " checked";}else{echo "";} echo "></td>
									<td><input type='checkbox' name='T_$noun$noel$nokuk' value='T'"; if ($smapa1b['bukti_T']=="T"){echo " checked";}else{echo "";} echo "></td>
									...
									<td><select name='met3_$noun$noel$nokuk' class='form-control' disabled>
										<option value='-'>-</option>
										<option value='CL'"; if ($smapa1b['metode3']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode3']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode3']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
								...
								<tr>
									<td><textarea name='bukti2_$noun$noel$nokuk' class='form-control' placeholder='isi bila terdapat bukti tambahan'>$smapa1b[ket_bukti2]</textarea></td>
									<td><input type='checkbox' name='L2_$noun$noel$nokuk' value='L'"; if ($smapa1b['bukti_L2']=="L"){echo " checked";}else{echo "";} echo "></td>
									<td><input type='checkbox' name='TL2_$noun$noel$nokuk' value='TL'"; if ($smapa1b['bukti_TL2']=="TL"){echo " checked";}else{echo "";} echo "></td>
									<td><input type='checkbox' name='T2_$noun$noel$nokuk' value='T'"; if ($smapa1b['bukti_T2']=="T"){echo " checked";}else{echo "";} echo "></td>
									<td><select name='met12_$noun$noel$nokuk' class='form-control' disabled>
										<option value='-'>-</option>
										<option value='CL'"; if ($smapa1b['metode1t']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode1t']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode1t']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode1t']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode1t']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode1t']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode1t']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
									<td><select name='met22_$noun$noel$nokuk' class='form-control' disabled>
										<option value='-'>-</option>
										<option value='CL'"; if ($smapa1b['metode2t']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode2t']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode2t']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode2t']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode2t']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode2t']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode2t']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
									<td><select name='met32_$noun$noel$nokuk' class='form-control'>
										<option value='-'>-</option>
										<option value='CL'"; if ($smapa1b['metode3t']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode3t']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode3t']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode3t']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode3t']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode3t']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode3t']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
									<td><select name='met42_$noun$noel$nokuk' class='form-control' disabled>
										<option value='-'>-</option>
										<option value='CL'"; if ($smapa1b['metode4t']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode4t']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode4t']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode4t']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode4t']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode4t']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode4t']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
									<td><select name='met52_$noun$noel$nokuk' class='form-control' disabled>
										<option value='-'>-</option>
										<option value='CL'"; if ($smapa1b['metode5t']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode5t']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode5t']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode5t']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode5t']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode5t']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode5t']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
									<td><select name='met62_$noun$noel$nokuk' class='form-control' disabled>
										<option value='-'>-</option>
										<option value='CL'"; if ($smapa1b['metode6t']=="CL"){echo " selected";}else{echo "";} echo ">CL (Ceklis Observasi/ Lembar Periksa)</option>
										<option value='DIT'"; if ($smapa1b['metode6t']=="DIT"){echo " selected";}else{echo "";} echo ">DIT (Daftar Instruksi Terstruktur)</option>
										<option value='DPL'"; if ($smapa1b['metode6t']=="DPL"){echo " selected";}else{echo "";} echo ">DPL (Daftar Pertanyaan Lisan)</option>
										<option value='DPT'"; if ($smapa1b['metode6t']=="DPT"){echo " selected";}else{echo "";} echo ">DPT (Daftar Pertanyaan Tertulis)</option>
										<option value='VP'"; if ($smapa1b['metode6t']=="VP"){echo " selected";}else{echo "";} echo ">VP (Verifikasi Portofolio)</option>
										<option value='CUP'"; if ($smapa1b['metode6t']=="CUP"){echo " selected";}else{echo "";} echo ">CUP (Ceklis Ulasan Produk)</option>
										<option value='PW'"; if ($smapa1b['metode6t']=="PW"){echo " selected";}else{echo "";} echo ">PW (Pertanyaan Wawancara)</option>
									</select></td>
								</tr>";
								$nokuk++;
							}
					...
					echo "</tbody></table><input type='submit' class='btn btn-success form-control' name='simpanbagian' value='Simpan Unit ini & Lanjut Pengisian'/>
					</div>";
					$noun++;
				}
			echo "<div class='box-footer'>
				...
				<div class='col-md-4 col-sm-12 col-xs-12'>
					<input type='submit' formaction='simpanmapa1b.php' class='btn btn-success form-control' name='simpan' value='Lanjut Pengisian Berikutnya'/>
				</div>
		 	</div>
          		</form>
		</div>
        ...
        <div class='col-xs-12'>
          <div class='box'>
			...
			echo "<div style='overflow-x:auto;'>
				...
				<thead><tr bgcolor='#D8D8D8'><th colspan='2'><b>Konfirmasi dengan orang yang relevan</b></th></tr></thead>
				<tbody>
					<tr><td><input type='checkbox' id='konf1' name='konf1' value='1'"; if ($smapa1['konfirm1']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label id='konf1'>Manajer sertifikasi LSP</label></td><td><input type='text' name='nama_konf1' class='form-control' placeholder='nama personil' value='$smapa1[konfirm1_ket]'/></td></tr>
					<tr><td><input type='checkbox' id='konf2' name='konf2' value='1'"; if ($smapa1['konfirm2']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label id='konf2'>Master Asesor / Master Trainer / Lead Asesor/ Asesor Utama Kompetensi</label></td><td><input type='text' name='nama_konf2' class='form-control' placeholder='nama personil' value='$smapa1[konfirm2_ket]'/></td></tr>
					<tr><td><input type='checkbox' id='konf3' name='konf3' value='1'"; if ($smapa1['konfirm3']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label id='konf3'>Manajer pelatihan Lembaga Training terakreditasi / Lembaga Training terdaftar</label></td><td><input type='text' name='nama_konf3' class='form-control' placeholder='nama personil' value='$smapa1[konfirm3_ket]'/></td></tr>
					<tr><td><input type='checkbox' id='konf4' name='konf4' value='1'"; if ($smapa1['konfirm4']=="1"){echo " checked";}else{echo "";} echo ">&nbsp;<label id='konf4'>Lainnya:</label></td><td><input type='text' name='nama_konf4' class='form-control' placeholder='nama personil' value='$smapa1[konfirm4_ket]'/></td></tr>
				</tbody>
			</table>";
			echo "</div>
			</div>
        ...
        <div class='col-xs-12'>
          <div class='box'>
				...
				while ($gtu=$getunit->fetch_assoc()){
					echo "<hr><table id='example9' class='table table-bordered table-striped'>
						...
						while ($gmuk=$getkatmuk->fetch_assoc()){
							$sqlgetmuk="SELECT * FROM `skema_mapa2` WHERE `id_skema`='$_GET[idsk]' AND `id_unitkompetensi`='$gtu[id]' AND `id_muk`='$gmuk[id]'";
							$getmuk=$conn->query($sqlgetmuk);
							$gtmuk=$getmuk->fetch_assoc();
							echo "<tr><td>$gmuk[id]<input type='hidden' name='id_muk$gtu[id]$gmuk[id]' value='$gmuk[id]'/></td><td>$gmuk[judul]</td>
							<td><input type='checkbox' name='muk$gtu[id]$gmuk[id]_1' id='options1$gtu[id]$gmuk[id]' value='1'";if ($gtmuk['kandidat1']=="1"){echo " checked";} echo"></td>
							<td><input type='checkbox' name='muk$gtu[id]$gmuk[id]_2' id='options2$gtu[id]$gmuk[id]' value='1'";if ($gtmuk['kandidat2']=="1"){echo " checked";} echo"></td>
							<td><input type='checkbox' name='muk$gtu[id]$gmuk[id]_3' id='options3$gtu[id]$gmuk[id]' value='1'";if ($gtmuk['kandidat3']=="1"){echo " checked";} echo"></td>
							<td><input type='checkbox' name='muk$gtu[id]$gmuk[id]_4' id='options4$gtu[id]$gmuk[id]' value='1'";if ($gtmuk['kandidat4']=="1"){echo " checked";} echo"></td>
							<td><input type='checkbox' name='muk$gtu[id]$gmuk[id]_5' id='options5$gtu[id]$gmuk[id]' value='1'";if ($gtmuk['kandidat5']=="1"){echo " checked";} echo"></td></tr>";
						}
					echo "</tbody></table>";
					$sqlgetkatkandidat="SELECT * FROM `kategori_kandidat` ORDER BY `kode` ASC";
					$getkatkandidat=$conn->query($sqlgetkatkandidat);
					echo "<p><b>*) diisi berdasarkan hasil penentuan pendekatan asesmen dan perencanaan asesmen<br>**) Keterangan:</b></p><ol>";
					while ($gkkan=$getkatkandidat->fetch_assoc()){
						echo "<li><b>$gkkan[deskripsi]</b></li>";
					}
					echo "</ol>";
				}
			echo "</div>
			...
			<div class='box-footer'>
				...
				<div class='col-md-4 col-sm-12 col-xs-12'>
					<a href='../asesor/form-mapa-02.php?idsk=$_GET[idsk]' class='btn btn-primary form-control'>Unduh Form MAPA-02</a>
				</div>
				<div class='col-md-4 col-sm-12 col-xs-12'>
					<button type='submit' class='btn btn-success form-control' name='simpan'>Simpan Jawaban</button>
				</div>

...
$pdf->Cell(190,5,'FR-MAK-01 :  CEKLIS MENGASES KOMPETENSI', '', 0,'L');
$pdf->Ln();

$pdf->SetFont('Arial','B','10');
$pdf->Cell(90,10,'LANGKAH', 'LTB', 0,'C');
$pdf->Cell(70,10,'SKENARIO', 'LTB', 0,'C');
$pdf->Cell(30,10,'KET.', 'LTBR', 0,'C');
$pdf->Ln();
...
$pdf->RowContent(array('  1.      Menyiapkan dan memelihara lingkungan asesmen'));
$pdf->SetFont('Arial','','10');
$pdf->SetWidths(array(10,80,70,30));
$pdf->RowContent(array('  1.1','Tempatkan peserta sertifikasi di posisi yang nyaman sebagai salah satu cara untuk memberikan lingkungan asesmen yang nyaman.','',''));
$pdf->RowContent(array('  1.2','Pastikan peserta anda sudah diterima menjadi peserta sertifikasi dan benar-benar memiliki kompetensi yang akan diases.','',''));
$pdf->SetFont('Arial','B','10');
$pdf->SetWidths(array(190));
$pdf->RowContent(array('  2.      Mengumpulkan bukti yang berkualitas'));
$pdf->SetFont('Arial','','10');
$pdf->SetWidths(array(10,80,70,30));
$pdf->RowContent(array('  2.1','Bersama peserta sertifikasi, kaji ulang acuan pembanding dan rencana asesmen termasuk jenis bukti, metode, sumber daya yang akan digunakan pada asesmen.','',''));
$pdf->RowContent(array('  2.2','Menerapkan prinsip asesmen dan aturan bukti dalam pengumpulan bukti yang dijelaskan melaui MMA 01 yang telah dibuat.','',''));
$pdf->RowContent(array('  2.3','Menentukan kesempatan pengumpulan bukti pada saat bekerja atau dalam aktifitas kerja yang disimulasikan bersama peserta berdasarkan APL 02 yang telah dikumpulkan bukti-buktinya.','',''));
$pdf->RowContent(array('  2.4.','Mengidentifikasi kesempatan untuk aktifitas asesmen terpadu dan jika memungkinkan memodifikasi perangkat asesmen.','',''));
$pdf->RowContent(array('  2.5','Membahas kebijakan yang relevan dan memastikan bahwa peserta mengerti implikasinya.','',''));
$pdf->RowContent(array('  2.6','Mendokumentasikan semua kesepakatan di atas lembar persetujuan termasuk persetujuan tanggal, tempat, waktu serta durasi asesmen lanjut.','','',));
$pdf->SetFont('Arial','B','10');
$pdf->SetWidths(array(190));
$pdf->RowContent(array('  3.      Mendukung Peserta'));
$pdf->SetFont('Arial','','10');
$pdf->SetWidths(array(10,80,70,30));
$pdf->RowContent(array('  3.1','Menempatkan peserta sertifikasi pada situasi yang nyaman sebagai persiapan pembimbingan.','',''));
$pdf->RowContent(array('  3.2','Menggunakan keterampilan komunikasi interpersonal pada saat menggunakan perangkat asesmen, termasuk mengomunikasikan penyesuaian yang memungkinkan.','',''));
$pdf->RowContent(array('  3.3','Menyediakan dukungan spesialis bila diperlukan','',''));
$pdf->RowContent(array('  3.4','Mengelola kesehatan dan keselamatan kerja pada saat pelaksanaan asesmen','',''));
$pdf->RowContent(array('  3.5','Mencatat hasil asesmen sesuai dengan metode dan  perangkat yang digunakan','',''));
$pdf->RowContent(array('  3.6','Jika seluruh bukti sudah dikumpulkan, sediakan waktu untuk anda mempertimbangkan hasil pengumpulan bukti.','',''));
$pdf->SetFont('Arial','B','10');
$pdf->SetWidths(array(190));
$pdf->RowContent(array('  4.      Membuat keputusan dan umpan balik asesmen'));
$pdf->SetFont('Arial','','10');
$pdf->SetWidths(array(10,80,70,30));
$pdf->RowContent(array('  4.1','Pastikan peserta sertifikasi diberikan umpan balik yang konstruktif','',''));
$pdf->RowContent(array('  4.2','Selesaikan dan tanda tangani laporan hail asesmen','',''));
$pdf->RowContent(array('  4.3','Ucapkan selamat atau memberikan motivasi kepada peserta sertifikasi.','',''));
...
//output file pdf
$fileoutputnya="FR-MAK-01-".$skemakkni."-".$as['nama'].".pdf";

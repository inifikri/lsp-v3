...
switch($_GET[act]){
  ...
  default:
    echo "<h2>Provinsi</h2>
          <table width=650px><tr><td><span style='float : right;'><input style='width: 100px; height: 25px;' type=button value='Tambah Provinsi' onclick=\"window.location.href='?module=propinsi&act=tambahpropinsi';\"></span></td></tr></table> 
          
          <table width=650px>
          <tr><th>no</th><th>nama Provinsi</th><th>aksi</th></tr>";

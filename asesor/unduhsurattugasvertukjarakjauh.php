...
$sqlasesi = "SELECT * FROM `asesi_tukjarakjauh` WHERE `jadwal`='$_GET[idj]'";
...
$sqlasesituk = "SELECT * FROM `asesi_tukjarakjauh` WHERE `jadwal_id`='$_GET[idj]' ORDER BY `aseso_id` ASC";

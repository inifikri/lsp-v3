...
function __construct($orientation='P', $unit='mm', $format='A4')
{
	...
	$this->PageFormats=array('a3'=>array(841.89,1190.55), 'a4'=>array(595.28,841.89), 'a5'=>array(420.94,595.28),
		'letter'=>array(612,792), 'legal'=>array(612,1008),'f4'=>array(595.28,841.89));
	if(is_string($format))
...
function Code39($xpos, $ypos, $code, $baseline=0.5, $height=5){
	...
	$this->Text($xpos, $ypos + $height + 4, 'Kode Verifikasi :'.strtoupper($code));
	$this->SetFillColor(0);
...
function RowContentNoBorderT($data)
{
    //Calculate the height of the row
    $nb=0;
    for($i=0;$i<count($data);$i++)
    ...
    for($i=0;$i<count($data);$i++)
    {
        ...
        //$this->Rect($x,$y,$w,$h);
        //Print the text
        $this->MultiCell($w,5,$data[$i],'LBR',$a);
        //Put the position to the right of the cell
        $this->SetXY($x+$w,$y);
    }
    //Go to the next line
...
function RowContentNoBorderB($data)
{
    //Calculate the height of the row
    $nb=0;
    for($i=0;$i<count($data);$i++)
...
function RowContentNoBorderTB($data)
{
    //Calculate the height of the row
    $nb=0;
    for($i=0;$i<count($data);$i++)
...
function RowContentNoBorder($data)
{
    //Calculate the height of the row
    $nb=0;
    for($i=0;$i<count($data);$i++)
...
function RowContentNoBorderJ($data)
{
    //Calculate the height of the row
    $nb=0;
    for($i=0;$i<count($data);$i++)
...
function RowContentNoBorderC($data)
{
    //Calculate the height of the row
    $nb=0;
    for($i=0;$i<count($data);$i++)

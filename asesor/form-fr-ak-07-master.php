...
$write->easyCell(':', 'align:C; font-size:10; border:LTBR');
$write->easyCell('nama asesi', 'align:L; border:LTBR');
$write->printRow();
...
$write->easyCell('Hasil pelatihan dan / atau pendidikan, dimana Kurikulum dan fasilitas praktek mampu telusur terhadap standar kompetensi', 'align:L; valign:M; border:TBR;');
$write->printRow();
...
$write->easyCell(
  '',
  'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTR; rowspan:6;'
);
...
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:8;'); // TIDAK

$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Ceklis observasi/demonstrasi Demonstrasi.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Pertanyaan lisan', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Pertanyaan tertulis.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Pertanyaan wawancara.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Daftar instruksi terstruktur.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Ceklis verifikasi portofolio.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan dukungan operator komputer.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LBR;');  $write->easyCell('...................................', 'align:L; valign:T; border:LBR;');  $write->printRow();
...
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:6;'); // YA
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:6;'); // TIDAK

$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan juru tulis.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan kameramen perekam vidio/atau audio.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Memperbolehkan periode waktu yang lebih panjang untuk menyelesaikan tugas pekerjaan dalam asesmen.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Melakukan tugas pekerjaan dalam asesmen dengan waktu lebih pendek.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan instruksi-instruksi spesifik pada proyek yang dapat dilakukan pada berbagai tingkatan.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LBR;');  $write->easyCell('.....................................', 'align:L; valign:T; border:LBR;');  $write->printRow();
...
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:3;'); // YA
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:3;'); // TIDAK

$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan pertanyaann lisan.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan pertanyaan wawancara.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LBR;');  $write->easyCell('......................................', 'align:L; valign:T; border:LBR;');  $write->printRow();
...
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:7;'); // YA
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:7;'); // TIDAK

$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Pertanyaan lisan.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Pertanyaan tulis.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Pertanyaan wawancara.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Ceklis Verifikasi portofolio', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Ceklis reviu produk.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Daftar instruksi terstruktur.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LBR;');  $write->easyCell('...................', 'align:L; valign:T; border:LBR;');  $write->printRow();
...
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:5;'); // YA
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:5;'); // TIDAK

$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan studi kasus/daftar instruksi terstruktur.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan instrumen asesmen dengan huruf normal jangan terlalu kecil.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan asesor dengan jenis kelamin yang sama dengan asesi.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan instrumen asesmen yang sama walaupun berbeda jenis kelamin (tidak boleh memberi tanda tambahan pada instrumen asesmen yang digunakan dengan tujuan untuk membedakan jenis kelamin).', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LBR;');  $write->easyCell('.........................', 'align:L; valign:T; border:LBR;');  $write->printRow();
...
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:4;'); // YA
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTBR; rowspan:4;'); // TIDAK

$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan studi kasus daftar instruksi terstruktur', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan asesor tanpa pertimbangan budaya/tradisi/agama.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LTRB;'); $write->easyCell('Menggunakan instrumen asesmen yang sama walaupun berbeda budaya/tradisi/agama.', 'align:L; valign:T; border:LTRB;'); $write->printRow();
$write->easyCell('', 'img:../images/unchecked.jpg, w5, h5; align:C; valign:M; border:LBR;');  $write->easyCell('................................', 'align:L; valign:T; border:LBR;');  $write->printRow();
...
$isi = 
  '1. Acuan Pembanding Asesmen: (tuliskan nama acuan pembanding)' . ($jjwb['aspek'] ?? '') . "\n" .
  '2. Metode Asesmen: (tuliskan nama acuan pembanding)' . ($jjwb['catatan_penolakan'] ?? '') . "\n" .
  '3. Instrumen Asesmen: (tuliskan nama formulir instrumen asesmen)' . ($jjwb['saran_perbaikan'] ?? '');
...
$write->easyCell('Nama Asesor:
 ' . $jjwb['catatan'], 'align:L; valign:T; border:LTR; font-size:10; font-style:B; rowspan:4');
...
$write->printRow();
$write->easyCell('Nama', 'align:L; font-size:10; border:LTBR;');
$write->easyCell('asesi', 'align:L; font-size:12; border:LTBR;');
$write->printRow();

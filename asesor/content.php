...
?>
		...
		<section class='content'>
								...
								<button type='button' class='btn btn-success dropdown-toggle' data-toggle='dropdown'>
									<span class='caret'></span>
															...
															<li class='divider'></li>";
																...
																<li><a href='?module=form-fr-ak-07&ida=$pm[id_asesi]&idj=$_GET[idj]' title='INPUT CEKLIS PENYESUAIAN YANG WAJAR DAN BERALASAN' target='_blank'>Formulir FR-AK-07</a></li>
								...
								<button type='button' class='btn btn-info dropdown-toggle' data-toggle='dropdown'>
									<span class='caret'></span>
															...
															<li class='divider'></li>
																...
																<li><a href='form-fr-ak-07.php?idass=$pm[id]&ida=$pm[id_asesi]&idj=$_GET[idj]' title='CEKLIS PENYESUAIAN YANG WAJAR DAN BERALASAN' target='_blank'>Formulir FR-AK-07</a></li>
				...
				<div class='row'>
					<div class='col-xs-12'>
						...
						<textarea class='form-control' name='catatan'>";
														...
														// var_dump($idj);
														// update WNP@PPM query ttd
														$sqlcektandatangan = "SELECT * FROM `logdigisign` WHERE `id_skema`='$jd[id_skemakkni]' AND `id_asesi`='$_SESSION[namauser]' AND nama_dokumen='FR.AK.05. LAPORAN ASESMEN' AND `id_jadwal`='$_GET[idj]' ORDER BY `id` DESC";
														$cektandatangan = $conn->query($sqlcektandatangan);
														$jumttd = $cektandatangan->num_rows;
														$ttdx = $cektandatangan->fetch_assoc();
														// belum fix
			...
			Input FR.AK.07. CEKLIS PENYESUAIAN YANG WAJAR DAN BERALASAN
				...
				<ol class='breadcrumb'>
					...
					Terimakasih, Anda telah melakukan <b>Ceklis penyesuaian yang wajar dan berasalan untuk Skema $sk[judul].</b><br>
					<a class='btn btn-warning form-control' href='?module=pesertaasesmen&idj=$_GET[idj]'>Kembali</a></div>
					...
					<a class='btn btn-warning form-control' href='?module=pesertaasesmen&idj=$_GET[idj]'>Kembali</a></div>";
																	...
																	$sqlinputak07 = "INSERT INTO `asesmen_ak07`(
																		`id_asesi`, `id_skemakkni`, `id_jadwal`,
																		`PA1`, `PA2`, `PA3`, `PA4`, `PA5`,
																		`KA1`, `KET1_1`, `KET1_2`, `KET1_3`, `KET1_4`, `KET1_5`, `KET1_6`,
																		`KA2`, `KET2_1`, `KET2_2`, `KET2_3`,
																		`KA3`, `KET3_1`, `KET3_2`, `KET3_3`, `KET3_4`, `KET3_5`, `KET3_6`, `KET3_7`, `KET3_8`,
																		`KA4`, `KET4_1`, `KET4_2`, `KET4_3`, `KET4_4`, `KET4_5`, `KET4_6`,
																		`KA5`, `KET5_1`, `KET5_2`, `KET5_3`,
																		`KA6`, `KET6_1`, `KET6_2`, `KET6_3`, `KET6_4`, `KET6_5`, `KET6_6`, `KET6_7`,
																		`KA7`, `KET7_1`, `KET7_2`, `KET7_3`, `KET7_4`, `KET7_5`,
																		`KA8`, `KET8_1`, `KET8_2`, `KET8_3`, `KET8_4`, `acuan`, `metode`, `instrumen`, `tanggal`
																	) VALUES (
																		'$_GET[ida]', '$jd[id_skemakkni]', '$_GET[idj]',
																		'$postPA1', '$postPA2', '$postPA3', '$postPA4', '$postPA5',
																		'$postKA1', '$postKET1_1', '$postKET1_2', '$postKET1_3', '$postKET1_4', '$postKET1_5', '$postKET1_6',
																		'$postKA2', '$postKET2_1', '$postKET2_2', '$postKET2_3',
																		'$postKA3', '$postKET3_1', '$postKET3_2', '$postKET3_3', '$postKET3_4', '$postKET3_5', '$postKET3_6', '$postKET3_7', '$postKET3_8',
																		'$postKA4', '$postKET4_1', '$postKET4_2', '$postKET4_3', '$postKET4_4', '$postKET4_5', '$postKET4_6',
																		'$postKA5', '$postKET5_1', '$postKET5_2', '$postKET5_3',
																		'$postKA6', '$postKET6_1', '$postKET6_2', '$postKET6_3', '$postKET6_4', '$postKET6_5', '$postKET6_6', '$postKET6_7',
																		'$postKA7', '$postKET7_1', '$postKET7_2', '$postKET7_3', '$postKET7_4', '$postKET7_5',
																		'$postKA8', '$postKET8_1', '$postKET8_2', '$postKET8_3', '$postKET8_4', '$_POST[acuan]', '$_POST[metode]', '$_POST[instrumen]',
																		'$tglsekarang'
																	)";
																	$conn->query($sqlinputak07);
																} else {
    ...
    <tr>
        <td rowspan='5' width='25%'>Potensi Asesi</td><td>";
            echo "<input type='checkbox' class='flat-red' name='checkboxPA1' id='optionsPA1' value='1'";
            if ($jjw['PA1'] == '1') {
                echo " checked";
            } else {
                echo "";
    ...
    <tr><td>";
            echo "<input type='checkbox' class='flat-red' name='checkboxPA2' id='optionsPA2' value='1'";
            if ($jjw['PA2'] == '1') {
                echo " checked";
            } else {
                echo "";
    ...
    <tr><td>";
            echo "<input type='checkbox' class='flat-red' name='checkboxPA3' id='optionsPA3' value='1'";
            if ($jjw['PA3'] == '1') {
                echo " checked";
            } else {
                echo "";
    ...
    <tr><td>";
            echo "<input type='checkbox' class='flat-red' name='checkboxPA4' id='optionsPA4' value='1'";
            if ($jjw['PA4'] == '1') {
                echo " checked";
            } else {
                echo "";
    ...
    <tr><td>";
            echo "<input type='checkbox' class='flat-red' name='checkboxPA5' id='optionsPA5' value='1'";
            if ($jjw['PA5'] == '1') {
                echo " checked";
            } else {
                echo "";
...
echo "<td><input type='radio' class='flat-red' name='checkboxKA1' value='1' " . ($jjw['KA1'] == '1' ? 'checked' : '') . "> Ya</td>";
echo "<td><input type='radio' class='flat-red' name='checkboxKA1' value='0' " . ($jjw['KA1'] == '0' ? 'checked' : '') . "> Tidak</td>";



echo "<td>
        <input type='checkbox' class='flat-red' name='checkboxKET1_1' value='1' " . ($jjw['KET1_1'] == '1' ? 'checked' : '') . "> Memerlukan dukungan pembaca, penerjemah, pelayan, penulis untuk merekam jawaban asesi.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET1_2' value='1' " . ($jjw['KET1_2'] == '1' ? 'checked' : '') . "> Melakukan asesmen verbal (gunakan pertanyaan lisan/pertanyaan wawancara) dengan dilengkapi gambar diagram dan bentuk visual.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET1_3' value='1' " . ($jjw['KET1_3'] == '1' ? 'checked' : '') . "> Menggunakan Hasil produksi<br>
        <input type='checkbox' class='flat-red' name='checkboxKET1_4' value='1' " . ($jjw['KET1_4'] == '1' ? 'checked' : '') . "> Menggunakan Ceklis observasi/demonstrasi<br>
        <input type='checkbox' class='flat-red' name='checkboxKET1_5' value='1' " . ($jjw['KET1_5'] == '1' ? 'checked' : '') . "> Menggunakan pertanyaan lisan dengan dilengkapi gambar diagram dan bentuk-bentuk visual.
      </td>";
echo "</tr>";
...
// Kolom Diperlukan Penyesuaian
echo "<td><input type='radio' class='flat-red' name='checkboxKA2' value='1' " . ($jjw['KA2'] == '1' ? 'checked' : '') . "> Ya</td>";
echo "<td><input type='radio' class='flat-red' name='checkboxKA2' value='0' " . ($jjw['KA2'] == '0' ? 'checked' : '') . "> Tidak</td>";



echo "<td>
        <input type='checkbox' class='flat-red' name='checkboxKET2_1' value='1' " . ($jjw['KET2_1'] == '1' ? 'checked' : '') . "> Menggunakan pertanyaan lisan dengan dilengkapi gambar diagram dan bentuk-bentuk visual.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET2_2' value='1' " . ($jjw['KET2_2'] == '1' ? 'checked' : '') . "> Menggunakan pertanyaan wawancara dengan dilengkapi gambar diagram dan bentuk-bentuk visual.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET2_3' value='1' " . ($jjw['KET2_3'] == '1' ? 'checked' : '') . "> ..............................................
      </td>";
echo "</tr>";
...
// Kolom Diperlukan Penyesuaian
echo "<td><input type='radio' class='flat-red' name='checkboxKA3' value='1' " . ($jjw['KA3'] == '1' ? 'checked' : '') . "> Ya</td>";
echo "<td><input type='radio' class='flat-red' name='checkboxKA3' value='0' " . ($jjw['KA3'] == '0' ? 'checked' : '') . "> Tidak</td>";



echo "<td>
        <input type='checkbox' class='flat-red' name='checkboxKET3_1' value='1' " . ($jjw['KET3_1'] == '1' ? 'checked' : '') . "> Ceklis observasi/demonstrasi Demonstrasi.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET3_2' value='1' " . ($jjw['KET3_2'] == '1' ? 'checked' : '') . "> Pertanyaan lisan<br>
        <input type='checkbox' class='flat-red' name='checkboxKET3_3' value='1' " . ($jjw['KET3_3'] == '1' ? 'checked' : '') . "> Pertanyaan tertulis.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET3_4' value='1' " . ($jjw['KET3_4'] == '1' ? 'checked' : '') . "> Pertanyaan wawancara.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET3_5' value='1' " . ($jjw['KET3_5'] == '1' ? 'checked' : '') . "> Daftar instruksi terstruktur.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET3_6' value='1' " . ($jjw['KET3_6'] == '1' ? 'checked' : '') . "> Ceklis verifikasi portofolio.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET3_7' value='1' " . ($jjw['KET3_7'] == '1' ? 'checked' : '') . "> Menggunakan dukungan operator komputer.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET3_8' value='1' " . ($jjw['KET3_8'] == '1' ? 'checked' : '') . "> ..............................................
      </td>";
echo "</tr>";
...
// Kolom Diperlukan Penyesuaian
echo "<td><input type='radio' class='flat-red' name='checkboxKA4' value='1' " . ($jjw['KA4'] == '1' ? 'checked' : '') . "> Ya</td>";
echo "<td><input type='radio' class='flat-red' name='checkboxKA4' value='0' " . ($jjw['KA4'] == '0' ? 'checked' : '') . "> Tidak</td>";



echo "<td>
        <input type='checkbox' class='flat-red' name='checkboxKET4_1' value='1' " . ($jjw['KET4_1'] == '1' ? 'checked' : '') . "> Menggunakan juru tulis.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET4_2' value='1' " . ($jjw['KET4_2'] == '1' ? 'checked' : '') . "> Menggunakan kameramen perekam vidio/atau audio.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET4_3' value='1' " . ($jjw['KET4_3'] == '1' ? 'checked' : '') . "> Memperbolehkan periode waktu yang lebih panjang untuk menyelesaikan tugas pekerjaan dalam asesmen.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET4_4' value='1' " . ($jjw['KET4_4'] == '1' ? 'checked' : '') . "> Melakukan tugas pekerjaan dalam asesmen dengan waktu lebih pendek.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET4_5' value='1' " . ($jjw['KET4_5'] == '1' ? 'checked' : '') . "> Menggunakan intruksi-instruksi spesifik pada proyek yang dapat dilakukan pada berbagai tingkatan.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET4_6' value='1' " . ($jjw['KET4_6'] == '1' ? 'checked' : '') . "> ..............................................
      </td>";
echo "</tr>";
...
// Kolom Diperlukan Penyesuaian
echo "<td><input type='radio' class='flat-red' name='checkboxKA5' value='1' " . ($jjw['KA5'] == '1' ? 'checked' : '') . "> Ya</td>";
echo "<td><input type='radio' class='flat-red' name='checkboxKA5' value='0' " . ($jjw['KA5'] == '0' ? 'checked' : '') . "> Tidak</td>";



echo "<td>
        <input type='checkbox' class='flat-red' name='checkboxKET5_1' value='1' " . ($jjw['KET5_1'] == '1' ? 'checked' : '') . "> Menggunakan pertanyaan lisan.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET5_2' value='1' " . ($jjw['KET5_2'] == '1' ? 'checked' : '') . "> Menggunaka pertanyaan wawancara.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET5_3' value='1' " . ($jjw['KET5_3'] == '1' ? 'checked' : '') . "> ..............................................
      </td>";
echo "</tr>";
...
// Kolom Diperlukan Penyesuaian
echo "<td><input type='radio' class='flat-red' name='checkboxKA6' value='1' " . ($jjw['KA6'] == '1' ? 'checked' : '') . "> Ya</td>";
echo "<td><input type='radio' class='flat-red' name='checkboxKA6' value='0' " . ($jjw['KA6'] == '0' ? 'checked' : '') . "> Tidak</td>";
echo "<td>
        <input type='checkbox' class='flat-red' name='checkboxKET6_1' value='1' " . ($jjw['KET6_1'] == '1' ? 'checked' : '') . "> Pertanyaan lisan.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET6_2' value='1' " . ($jjw['KET6_2'] == '1' ? 'checked' : '') . "> Pertanyaan tulis.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET6_3' value='1' " . ($jjw['KET6_3'] == '1' ? 'checked' : '') . "> Pertanyaan wawancara.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET6_4' value='1' " . ($jjw['KET6_4'] == '1' ? 'checked' : '') . "> Ceklis Verifikasi portofolio.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET6_5' value='1' " . ($jjw['KET6_5'] == '1' ? 'checked' : '') . "> Ceklis reviu produk.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET6_6' value='1' " . ($jjw['KET6_6'] == '1' ? 'checked' : '') . "> Daftar instruksi terstruktur.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET6_7' value='1' " . ($jjw['KET6_7'] == '1' ? 'checked' : '') . "> ..............................................
      </td>";
echo "</tr>";
...
// Kolom Diperlukan Penyesuaian
echo "<td><input type='radio' class='flat-red' name='checkboxKA7' value='1' " . ($jjw['KA7'] == '1' ? 'checked' : '') . "> Ya</td>";
echo "<td><input type='radio' class='flat-red' name='checkboxKA7' value='0' " . ($jjw['KA7'] == '0' ? 'checked' : '') . "> Tidak</td>";
echo "<td>
        <input type='checkbox' class='flat-red' name='checkboxKET7_1' value='1' " . ($jjw['KET7_1'] == '1' ? 'checked' : '') . "> Menggunakan studi kasus/daftar instruksi terstruktur<br>
        <input type='checkbox' class='flat-red' name='checkboxKET7_2' value='1' " . ($jjw['KET7_2'] == '1' ? 'checked' : '') . "> Menggunakan instrumen asesmen dengan huruf normal jangan terlalu kecil<br>
        <input type='checkbox' class='flat-red' name='checkboxKET7_3' value='1' " . ($jjw['KET7_3'] == '1' ? 'checked' : '') . "> Menggunakan asesor dengan jenis kemanin yang sama dengan asesi<br>
        <input type='checkbox' class='flat-red' name='checkboxKET7_4' value='1' " . ($jjw['KET7_4'] == '1' ? 'checked' : '') . "> Menggunakan instrumen asesmen yang sama walaupun berbeda jenis kelamin (tidak boleh memberi tanda tambahan pada instrumen asesmen yang digunakan dengan tujuan untuk membedakan jenis kelamin).<br>
        <input type='checkbox' class='flat-red' name='checkboxKET7_5' value='1' " . ($jjw['KET7_5'] == '1' ? 'checked' : '') . "> ..............................................
      </td>";
echo "</tr>";
...
// Kolom Diperlukan Penyesuaian
echo "<td><input type='radio' class='flat-red' name='checkboxKA8' value='1' " . ($jjw['KA8'] == '1' ? 'checked' : '') . "> Ya</td>";
echo "<td><input type='radio' class='flat-red' name='checkboxKA8' value='0' " . ($jjw['KA8'] == '0' ? 'checked' : '') . "> Tidak</td>";
echo "<td>
        <input type='checkbox' class='flat-red' name='checkboxKET8_1' value='1' " . ($jjw['KET8_1'] == '1' ? 'checked' : '') . "> Menggunakan studi kasus daftar instruksi terstruktur<br>
        <input type='checkbox' class='flat-red' name='checkboxKET8_2' value='1' " . ($jjw['KET8_2'] == '1' ? 'checked' : '') . "> Menggunakan asesor tanpa pertimbangan budaya/tradisi/agama.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET8_3' value='1' " . ($jjw['KET8_3'] == '1' ? 'checked' : '') . "> Menggunakan instrumen asesmen yang sama walaupun berbeda budaya/tradisi/agama.<br>
        <input type='checkbox' class='flat-red' name='checkboxKET8_4' value='1' " . ($jjw['KET8_4'] == '1' ? 'checked' : '') . "> ..............................................
      </td>";
echo "</tr>";
...
// echo "</tr>";
						...
						<thead><tr><th>Hasil Penyesuaian yang wajar dan beralasan disepakati menggunakan : </th></tr></thead>
							<tr><td width='25%'>Acuan Pembanding Asesmen : </td><td colspan='2'><textarea name='acuan' class='form-control'>$jjw[acuan]</textarea></td></tr>
							<tr><td width='25%'>Metode Asesmen : </td><td colspan='2'><textarea name='metode' class='form-control'>$jjw[metode]</textarea></td></tr>
							<tr><td width='25%'>Instrumen Asesmen : </td><td colspan='2'><textarea name='instrumen' class='form-control'>$jjw[instrumen]</textarea></td></tr>
						</table>
						...
						<p><b>Asesor :</b>
														...
														$url = "{$_SERVER['HTTP_HOST']}{$_SERVER['REQUEST_URI']}";
														$iddokumen = md5($url);
														$sqlcektandatangan = "SELECT * FROM `logdigisign` WHERE id_dokumen = '$iddokumen' AND id_skema = '$sk[id]' AND id_asesi = '$_SESSION[namauser]' AND id_jadwal = '$_GET[idj]' ORDER BY id DESC";
														$cektandatangan = $conn->query($sqlcektandatangan);
														$jumttd = $cektandatangan->num_rows;
														$ttdx = $cektandatangan->fetch_assoc();
														if ($jumttd > 0) {
						...
						<div class='col-md-4 col-sm-12 col-xs-12'>
								<a href='form-fr-ak-07.php?ida=$_GET[ida]&idj=$_GET[idj]' class='btn btn-primary form-control' target='_blank'>Unduh Formulir</a>
						</div>
						<div class='col-md-4 col-sm-12 col-xs-12'>
								<button type='submit' class='btn btn-success form-control' name='simpan'>Simpan Jawaban</button>
						</div>
...
presentasi</li>
				...
				<td>
					<div class="form-check">
						<input class="form-check-input" type="radio" name="pencapaian<?= $gp['idpertanyaan'] ?>" id="flexRadioDefault<?= $gp['idpertanyaan'] ?>" value="Ya" <?php if ($gfr['pencapaian'] == 'Ya') {
																																												echo "checked";
																																											} ?>>
					</div>
				</td>
				<td>
					<div class='form-check'>
						<input class="form-check-input" type="radio" name="pencapaian<?= $gp['idpertanyaan'] ?>" id="flexRadioDefault<?= $gp['idpertanyaan'] ?>" value="Tidak" <?php if ($gfr['pencapaian'] == 'Tidak') {
																																													echo "checked";
																																												} ?>>
					</div>
				</td>
		...
		?>
		<div class="form-check">
			<input class="form-check-input" type="radio" name="rekomendasi" value="K" id="flexRadioDefault1" <?php if ($gtas['rekomendasi_IA04B'] == 'K') {
																													echo 'checked';
																												} ?>>
		...
		<div class="form-check">
			<input class="form-check-input" type="radio" name="rekomendasi" value="BK" id="flexRadioDefault2" <?php if ($gtas['rekomendasi_IA04B'] == 'BK') {
																													echo 'checked';
																												} ?>>
			<label class="form-check-label" for="flexRadioDefault1">
				Belum Kompeten
	...
	<?php
							...
							<tr>
								...
								<td>:</td>
								<td>" . tgl_indo($ttdxasesi['waktu']) . "<br><img src='../$ttdxasesi[file]' width='400px'/></td>
							</tr>
							<tr>

...
if (empty($_SESSION['username']) AND empty($_SESSION['passuser'])){
 ...
 <center><br><br><br><br><br><br>Maaf, untuk masuk <b>Halaman Asesor</b><br>
...
<title>Dahsboard Asesor | Sistem Informasi Lembaga Sertifikasi Profesi</title>
...
<div class='wrapper'>
  ...
  <header class='main-header'>
    ...
    <a href='?module=home' class='logo'>
      ...
      <span class='logo-lg'>Asesor <b>LSP</b></span>
    </a>
    ...
    <nav class='navbar navbar-static-top' role='navigation'>
      ...
      <div class='navbar-custom-menu'>
		...
		$sqlgethpasr="SELECT * FROM `asesor` WHERE `no_ktp`='$_SESSION[namauser]'";
	...
	echo "</a> 
		...
		$sqlgetuser="SELECT * FROM `asesor` WHERE `no_ktp`='$_SESSION[namauser]'";
		...
		if ($_SESSION['foto']==''){
			...
			$new_file_directory = '../foto_asesor/'.$_SESSION['foto'];
		...
		if ($_SESSION['foto']==''){
			...
			$new_file_directory = '../foto_asesor/'.$_SESSION['foto'];
			$new_file_directory2 = '../foto_asesor/'.$_SESSION['foto'];
			echo "<img src='$new_file_directory'  class='user-image' alt='User Image'/>";
		}
        echo "<p>
                  <small>";

		    	...
		    	<div class="pageContent">
		    		...
		    		<div class="page-title title-1">
						<div class="container">
							<div class="row">
								<h1>Pendaftaran</h1>
								<h3>Formulir pendaftaran akun pengusul peserta uji kompetensi sertifikasi profesi</h3>
						...
						<div class="container">
							<div class="row">
								<div class="col-md-7 contact-form">
				    				<div class="heading">
										<h3 class="uppercase head-6"><span class="main-color">Pendaftaran</span> Pengusul</h3>
									</div>
									<?php
		                		$sql="SELECT * FROM `data_wilayah`";
						echo "<form action='pendaftaran-pengusul.php' method='post'>
							<div class='form-input'>
				    						<label>Nama Institusi Pengusul<span class='red'>*</span></label><input type='text' name='nama_kantor' placeholder='Nama Institusi Pengusul' class='form-control shape' required>
							</div>
							<div class='form-input'>
				    						<label>Alamat Email Institusi<span class='red'></span></label><input type='email' name='email_kantor' placeholder='Alamat Email Institusi'class='form-control shape' >
							</div>
							<div class='form-input'>
				    						<label>Nomor Telepon Institusi<span class='red'>*</span></label><input type='text' name='telp_kantor' placeholder='Nomor Telepon Institusi' maxlength='14' class='form-control shape' required>
							</div>
							<div class='form-input'>
				    						<label>Nomor Fax Institusi<span class='red'></span></label><input type='text' name='fax_kantor' placeholder='Nomor Fax Institusi' maxlength='14'class='form-control shape' >
							</div>
							<div class='form-input'>
				    						<label>Jenis Institusi Pengusul<span class='red'>*</span></label><select name='jenis_kantor' placeholder='Jenis Institusi Pengusul' class='form-control shape' required>
								<option>Pilih Jenis Institusi</option>
								<option value='pemerintah'>Institusi Pemerintah</option>
								<option value='swasta'>Institusi Swasta</option>
								<option value='asing'>Institusi Asing (Foreign Institution)</option>
							</select>
							</div>
							<div class='form-input'>
				    						<label>Alamat Institusi<span class='red'>*</span></label><input type='text' name='alamat' placeholder='Alamat Institusi' class='form-control shape' required>
							<!--<input type='text' name='kelurahan' placeholder='Desa/Kelurahan' class='form-control shape' required>-->
							...
							<div class='form-input'>
				    						<label>Nama Penangungjawab<span class='red'>*</span></label><input type='text' name='nama' placeholder='Nama Penangungjawab' class='form-control shape' required>
							</div>
							<div class='form-input'>
				    						<label>Alamat Email Penanggungjawab<span class='red'></span></label><input type='email' name='email' placeholder='Alamat Email Penanggungjawab' class='form-control shape' >
							</div>
							<div class='form-input'>
				    						<label>Nomor HP Penanggungjawab<span class='red'>*</span></label><input type='text' name='no_hp' placeholder='Nomor HP Penanggungjawab' maxlength='14' class='form-control shape' required>
							</div>
							<div class='form-input'>
				    						<label>Nomor KTP/NIK Penanggungjawab<span class='red'>*</span></label><input type='text' name='no_ktp' placeholder='Nomor KTP/NIK Penanggungjawab' class='form-control shape' maxlength='16' required>
							</div>
							<input type='submit' value='DAFTAR' class='btn btn-md main-bg shape'>
					    		...
					    		<div class="col-md-5">
									...
									<div class="msg-box warning-box shape">
										...
										<p>Peserta uji kompetensi dapat didaftarkan melalui laman ini. Setelah melakukan pendaftaran, periksa inbox (kotak masuk) email anda, bila tidak terdapat pada inbox email anda silahkan periksa di SPAM email anda</p>
									</div>
									
									<p>Akun pengusul hanya satu akun untuk satu institusi yang sama.</p>
									
									<p>Akun peserta hanya dapat didaftarkan oleh pengusul institusi atau dinas terkait.</p>

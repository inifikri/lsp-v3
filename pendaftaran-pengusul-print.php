...
<head>
  ...
  <title>SILSP | Bukti Pendaftaran Akun Pengusul Peserta</title>
          ...
          <div class='row'>
            <div class='col-xs-12'>
              <h2 class='page-header'>
                <i class='fa fa-globe'></i> Pendaftaran Institusi Pengususl Peserta Sistem Informasi LSP
          ...
          <div class='row invoice-info'>
            <div class='col-xs-9'>
              ...
              <address>
                ...
                Institusi :<br><strong>$_POST[institusi]</strong><br>
        ...
        if ($_POST[biaya]!='0'){
          echo"<div class='row'>
            ...
            <div class='col-xs-6'>
              ...
              $getbank=mysql_query("SELECT * FROM `rekeningbayar` WHERE `aktif`='Y'");

              while ($rek=mysql_fetch_assoc($getbank)){

...
<head>
  ...
  <title>SILSK | Bukti Penerimaan Pengaduan</title>
          ...
          <div class='row'>
            <div class='col-xs-12'>
              <h2 class='page-header'>
                ...
                <small class='pull-right'>Tanggal Pengaduan: $_POST[tgl_daftar]</small>
              </h2>
            </div>
            <!-- /.col -->
          </div>
          ...
          <div class='row invoice-info'>
            <div class='col-xs-9'>
              ...
              <address>
                ...
                No. Tiket :<br><strong>$_POST[nopendaf]</strong><br>
                No. HP :<br><strong>$_POST[no_hp]</strong><br>
                Email :<br><strong>$_POST[email]</strong><br>
                Aduan :<br><strong>$_POST[aduan]</strong>
              </address>
            </div>
          </div>
          <!-- /.row -->";

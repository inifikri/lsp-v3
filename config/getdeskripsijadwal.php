...
echo "<p class='text-red' id='deskripsijadwal'>Gelombang $desc[gelombang] $desc[periode] $desc[tahun]<br>Tanggal $tglasesmen Pukul $desc[jam_asesmen] di $tmpt[nama]<br>Asesor :<br>";

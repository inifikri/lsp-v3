...
function UploadFileRPL($fupload_name){
	//direktori file
  	$vdir_upload = "../../dokumenAsesi/";
	$vfile_upload = $vdir_upload . $fupload_name;
	$tipe_file   = $_FILES['fupload']['type'];
...
function UploadFiletxt($fupload_name){
  //direktori gambar
  $vdir_upload = "../../filetxt/";
  $vfile_upload = $vdir_upload . $fupload_name;
  $tipe_file   = $_FILES['fupload']['type'];
...
function UploadFileDocAsesi($fupload_name){
	//direktori file
  	$vdir_upload = "dokumenAsesi/";
	$vfile_upload = $vdir_upload . $fupload_name;
	$tipe_file   = $_FILES['fupload']['type'];
...
function UploadFileDocAsesi2($fupload_name){
	//direktori file
  	$vdir_upload = "/dokumenAsesi/";
	$vfile_upload = $vdir_upload . $fupload_name;
	$tipe_file   = $_FILES['fupload']['type'];
...
function UploadFileDocAsesi3($fupload_name){
	//direktori file
  	$vdir_upload = "../dokumenAsesi/";
	$vfile_upload = $vdir_upload . $fupload_name;
	$tipe_file   = $_FILES['fupload']['type'];
...
function UploadFileDocAsesi4($fupload_name){
	//direktori file
  	$vdir_upload = "../../dokumenAsesi/";
	$vfile_upload = $vdir_upload . $fupload_name;
	$tipe_file   = $_FILES['fupload']['type'];
